...
1. **La tenue professionnelle** : barrière physique, changée régulièrement, ne sortant jamais de l'unité de soins
2. **Le circuit propre/sale** : organisation spatiale et procédurale garantissant que le propre et le sale ne se croisent jamais
...
- SHA avant toute préparation médicamenteuse
- Pas d'interruption de tâche pendant la préparation des médicaments (risque d'erreur médicamenteuse)
...
- Ne jamais ramener un matériel "sale" vers la zone propre du chariot
- Désinfecter le chariot en fin de tournée (surface + roues)
...
- Flacon multi-dose : noter la date d'ouverture, durée de conservation limitée (selon RCP)
- Pas de téléphone, pas d'interruption → risque d'erreur médicamenteuse multiplié x 5
...
**Linge souillé :**
- Conditionnement dans un sac plastique **dans la chambre ou à la source** (jamais déplié dans le couloir)
- Sac fermé hermétiquement
- **Jamais posé à terre** (même en sac fermé)
- Transport en chariot fermé ou sac en filet hermétique
- Circuit séparé du linge propre (ne jamais croiser les deux dans le même couloir en même temps si possible)

**Linge propre :**
- Rangé dans une armoire dédiée, zone propre
- Jamais posé sur les lits des patients (contamination de l'environnement)
- Livré en chariot fermé depuis la blanchisserie
...
> [!warning] Interruption de préparation médicamenteuse
> Une étude a montré que les interruptions de tâche pendant la préparation des médicaments multiplient par 5 le risque d'erreur. Poser une signalétique "Ne pas déranger" si le service dispose d'une procédure. Terminer la préparation avant de répondre, sauf urgence vitale.
