---
{"dg-publish":true,"permalink":"/hygiene/dasri-dechets-hospitaliers/","tags":["hygiène","DASRI","déchets hospitaliers","AES","tri des déchets","filière"],"noteIcon":"","dg-note-properties":{"nom":"DASRI et déchets hospitaliers","classe":["Hygiène hospitalière"],"type":"Fiche technique","tags":["hygiène","DASRI","déchets hospitaliers","AES","tri des déchets","filière"],"revision":"2026-06-22"}}
---
...
**Cadre réglementaire** : décret 97-1048 du 6 novembre 1997 relatif à l'élimination des DASRI, et circulaires ultérieures. Contrôle par les DREAL (Direction Régionale de l'Environnement).
...
**Exemples :**
- Aiguilles, lancettes, lames de bistouri → **boîte jaune DASRI piquants-coupants**
- Compresses et gants souillés de sang ou de liquides biologiques
- Tubulures de perfusion, poches à urine, sacs de drainage
- Aspirations trachéales, sondes urinaires
- Matériel de prélèvement sanguin

**Contenant :**
- Boîte jaune (piquants-coupants) pour aiguilles, lancettes, stylos à insuline usagés
- Sac jaune (mou) pour les autres DASRI non piquants
...
**Exemples :**
- Matériel de préparation des cytotoxiques (seringues, tubulures, flacons vides)
- Protections et vêtements souillés lors de la préparation
- Déchets du patient pendant **48 heures** après administration (urines, selles, vomissements → contiennent des métabolites actifs)
...
**Exemples :**
- Emballages en carton, plastique propre
- Papiers, mouchoirs non souillés
- Restes alimentaires
- Médicaments non utilisés → filière spécifique (pharmacie, CYCLAMED)

**Contenant : sac noir** → collecte standard.
...
4. **Traitement** : incinération obligatoire dans une UIOM (Unité d'Incinération des Ordures Ménagères) agréée ou benne agréée
...
- En cas de contrôle DREAL, l'absence de BSD est une infraction
...
> [!warning] Chimio : 48h de précaution
> Les urines, selles et vomissements d'un patient ayant reçu une chimiothérapie contiennent des métabolites actifs pendant 48 heures. Traiter tous les déchets souillés de ce patient comme DASRI cytotoxiques (sac violet) pendant cette période.
