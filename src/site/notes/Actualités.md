...
> Pédiatrie : ACR nourrisson, Bronchiolite, Convulsions fébriles, Déshydratation enfant, Détresse respiratoire nourrisson, Fièvre enfant
> Obstétrique : Pré-éclampsie, Hémorragie post-partum, Menace d'accouchement prématuré
> Gériatrie : Chutes, Déshydratation sujet âgé, Syndrome de glissement, Dénutrition
> Spécialisé : OAP, SDRA, Acidocétose diabétique, DT1, IRC, Hémorragie digestive, Guillain-Barré, HPP, Coma, Traumatisme crânien, Intoxication, HTIC, Appendicite, Péritonite, Endocardite, Pyélonéphrite, SCA, Polytraumatisme, SEP, CIVD, Pied diabétique, Obésité, PAVM, Mucite, NV chimio...
>
> **Médicaments : 25 → 248 fiches (44 classes thérapeutiques)**
> Antibiotiques, Anticoagulants, Antidépresseurs (ISRS/IRSN), Antipsychotiques, Benzodiazépines, Antiépileptiques, Antidiabétiques, IEC/ARA2, Statines, Corticoïdes, AINS, Antalgiques, Vasopresseurs, Chimiothérapies...
>
> **Soins Infirmiers : 28 → 69 fiches**
> ETP (Asthme, Diabète, HTA, IC, Principes), Soins palliatifs (accompagnement famille, sédation profonde, confort), Psychiatrie (entretien IDE, soins sans consentement, crise suicidaire), Oncologie (chimiothérapie, stomie, trachéotomie, PICC Line), ECG avancé (arythmies, IDM), Dialyse/hémodialyse, Nutrition clinique, Relève SBAR, Ventilation mécanique...
>
> **Cas Cliniques : 10 → 20 fiches**
> CC1 IDM urgences, CC2 Diabète/Hypoglycémie, CC3 AVC Neurologie, CC4 Sepsis Réanimation
> + Transmissions ciblées : AVC, EP, IDM, IRA, Pancréatite, Sepsis
> Format amélioré : solution masquée dans callout repliable
...
>
> **Nouveaux Cas Cliniques (7) + Pharmacologie (7)**
> OAP/IC aiguë, Choc anaphylactique, ACR/RCP, BPCO, Post-op abdominal, FA sur valvulopathie, Méningite bactérienne
