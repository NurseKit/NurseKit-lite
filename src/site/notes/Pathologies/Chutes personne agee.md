---
{"dg-publish":true,"permalink":"/Pathologies/Chutes personne agee/","tags":["pathologie","gériatrie","chutes","prévention"],"noteIcon":"","dg-note-properties":{"nom":"Chutes de la personne âgée","systeme":"Gériatrie","tags":["pathologie","gériatrie","chutes","prévention"],"revision":"2026-06-14"}}
---
...
Épidémiologie :
- 1/3 des personnes de plus de 65 ans chute au moins une fois par an
...
- Mauvais éclairage (notamment la nuit)
- Chaussures inadaptées (pantoufles sans talon, talons hauts)
- Mobilier encombrant, câbles au sol
- Absence de barres d'appui (WC, douche)
- Lit trop haut, sonnette inaccessible

**Outils d'évaluation du risque :**
- **Score de Morse** : utilisé en milieu hospitalier (6 items : antécédents de chute, diagnostic secondaire, aide à la marche, perfusion IV, démarche, état mental)
- **Test de Tinetti** : évalue la marche et l'équilibre (< 19/28 = risque élevé)
...
> [!danger] Temps au sol > 1 heure : risque de rhabdomyolyse (destruction musculaire) avec insuffisance rénale aiguë. Bilan biologique urgent avec CPK, créatinine, myoglobine urinaire.

> [!warning] La chute peut être le signe révélateur d'une pathologie aiguë sous-jacente : infection, trouble du rythme cardiaque, AVC, hypoglycémie. Chercher la cause systématiquement.
