...
- [ ] Évaluation systématique à chaque soin : localisation, dimensions (L × l × P), stade T.I.M.E, exsudat, odeur, berges, douleur (EVA)
- [ ] Choix du pansement selon stade :
...
- [ ] Ulcère veineux : contention après cicatrisation, jambe surélevée au repos
- [ ] Ulcère artériel : NE PAS comprimer (contre-indiqué si IPS < 0,6), contrôle vasculaire urgent
- [ ] Mal perforant plantaire : décharge stricte du membre (fauteuil roulant, chaussure de décharge)
- [ ] Lutte contre la dénutrition : zinc, vitamine C, protéines → indispensables à la cicatrisation
- [ ] Traçabilité et photographie horodatée à chaque pansement

## Points de vigilance

> [!danger] Contention et ischémie artérielle
...
> [!warning] Infection de plaie chronique vs colonisation
...
1. **"Évaluer T.I.M.E avant chaque soin"** → le pansement se choisit en fonction du tissu et de l'humidité, pas par habitude
2. **"Ulcère artériel = jamais de compression"** → mesurer l'IPS ou appeler le médecin avant d'appliquer une bande
3. **"Décharge + nutrition = base du traitement"** → sans décharger et sans corriger la dénutrition, aucun pansement ne cicatrisera

## Voir aussi

[[Pathologies/Artérite des membres inférieurs\|Artérite des membres inférieurs]] · [[Pathologies/Diabète de type 2\|Diabète de type 2]] · [[Pathologies/Insuffisance cardiaque\|Insuffisance cardiaque]] · [[Pathologies/Dénutrition\|Dénutrition]] · [[Pathologies/Escarre\|Escarre]]

> [!caution] Outil pédagogique · Source : HAS / SFETD recommandations
