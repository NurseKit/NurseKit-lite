...
- [ ] Dexaméthasone IV avant ou avec les antibiotiques (réduit les séquelles auditives si pneumocoque)
- [ ] **Surveiller le purpura** heure par heure : extension rapide des taches → appel médecin urgence absolue
- [ ] Signalement ARS si méningocoque (déclaration obligatoire dans les 24h)
...
> [!danger] Ne jamais retarder les antibiotiques pour attendre la PL
