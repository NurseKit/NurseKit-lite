...
> [!danger] Purpura fulminans = urgence dans les 30 min
...
**À l'admission :**
- [ ] Installer en chambre individuelle, lumière tamisée, calme (photophobie)
- [ ] Poser 2 VVP de bon calibre (18G minimum) → prélèvements AVANT antibiothérapie si possible
- [ ] Prélèvements : hémocultures x 2, NFS, CRP, PCT, ionogramme, créatinine, bilan hépatique, TP/TCA
- [ ] Mise en place du scope : PA, FC, SpO2, température, FR, diurèse
- [ ] Préparer le matériel pour la ponction lombaire (PL) si prescrite
...
**Mesures d'isolement :**
- [ ] Précautions gouttelettes (masque chirurgical) jusqu'à 24h d'antibiothérapie efficace
...
> [!danger] Contre-indication à la PL si signes d'HTIC
...
> [!warning] Ne jamais retarder l'antibiothérapie
