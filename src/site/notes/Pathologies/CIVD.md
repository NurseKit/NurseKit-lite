---
{"dg-publish":true,"permalink":"/Pathologies/CIVD/","tags":["pathologie","réanimation","hématologie","coagulation","urgence"],"noteIcon":"","dg-note-properties":{"nom":"CIVD - Coagulation Intravasculaire Disséminée","systeme":"Réanimation / Hématologie","tags":["pathologie","réanimation","hématologie","coagulation","urgence"],"revision":"2026-06-14"}}
---
...
- [ ] Signaler immédiatement tout saignement anormal à un soignant (points de ponction qui n'arrêtent pas de saigner, ecchymoses nouvelles)
- [ ] Bilan biologique urgent : NFS plaquettes, TP, TCA, fibrinogène, D-dimères, schizocytes (frotti sanguin), lactates, bilan hépatique
- [ ] **Compression manuelle** de tous les points de saignement extériorisés
...
- [ ] Limiter les gestes invasifs au strict minimum tant que TP < 50%
- [ ] Surveiller les signes d'ischémie : coloration des extrémités, pouls distaux, diurèse (IRA)
- [ ] Scope continu : TA, FC, SpO₂, conscience, diurèse horaire

## ⚠️ Points de vigilance

> [!danger] Ne jamais traiter la CIVD sans traiter la cause
...
> [!warning] Héparine en CIVD thrombotique
...
> [!caution] Gestes invasifs à éviter
