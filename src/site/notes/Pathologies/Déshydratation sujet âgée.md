---
{"dg-publish":true,"permalink":"/pathologies/deshydratation-sujet-agee/","tags":["pathologie","gériatrie","hydratation","déshydratation"],"noteIcon":"","dg-note-properties":{"nom":"Déshydratation de la personne âgée","systeme":"Gériatrie","tags":["pathologie","gériatrie","hydratation","déshydratation"],"revision":"2026-06-22"}}
---
...
- Diminution de la sensation de soif (adipsia partielle)
- Réduction de la capacité de concentration rénale
- Diminution de la masse hydrique totale : 60 % → 50 % du poids corporel
- Prise fréquente de diurétiques
- Réduction des apports oraux (troubles de la déglutition, dépendance, anorexie)

**Deux types principaux :**

| Type | Mécanisme | Causes fréquentes | Signe biologique |
|---|---|---|---|
| **Extracellulaire** | Perte de sel ET d'eau | Diarrhées, vomissements, diurétiques, fistules | Hyponatrémie ou natrémie normale, hémoconcentration |
...
| Signe | Déshydratation extracellulaire | Déshydratation intracellulaire |
|---|---|---|
| Soif | Absente (réflexe émoussé) | Présente mais émoussée |
| Peau / muqueuses | Pli cutané (peu fiable chez PA) | Sécheresse des muqueuses, langue sèche |
| Cardiovasculaire | Hypotension orthostatique, tachycardie, veines plates | Peu marqué au début |
| Neurologique | Confusion, asthénie | **Confusion, agitation, convulsions si sévère** |
| Autres | Oligurie, yeux cernés | Fièvre, hyperthermie |

> [!warning] Chez la personne âgée, la confusion est souvent le PREMIER signe de déshydratation, avant même les signes classiques. Toute confusion aiguë doit faire évaluer l'hydratation.
...
| Voie | Indications | Solutés |
|---|---|---|
| **Orale** | Patient conscient, pas de trouble de la déglutition, déshydratation modérée | Eau + bouillons salés si DEC, eau seule si DIC |
| **Intraveineuse** | Déshydratation sévère, troubles de conscience, échec voie orale | NaCl 0,9 % si DEC, G5 % si DIC, soluté mixte si déshydratation mixte |
| **Sous-cutanée (hypodermoclyse)** | Sujet âgé, hydratation modérée, pas d'accès veineux | NaCl 0,9 % ou G5 % selon prescription |

- [ ] Bilan entrées/sorties renseigné à chaque poste
...
> [!danger] Ne jamais réhydrater trop vite par voie IV une personne âgée insuffisante cardiaque : risque d'OAP. La réhydratation doit être progressive et surveillée (PA, fréquence respiratoire, SpO2).
