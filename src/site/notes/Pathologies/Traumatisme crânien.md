...
- [ ] **Scope continu immédiat** : TA (objectif PAS ≥ 120 mmHg en phase aiguë), FC, SpO₂ > 98 %, ETCO₂ si disponible
- [ ] **Intubation rapide** (GCS ≤ 8) : préparer le matériel, médicaments de séquence rapide (étomidate ou kétamine + succinylcholine)
- [ ] **Position tête à 30° dans l'axe** → jamais de rotation de la tête (compression jugulaire = HTIC aggravée)
- [ ] Objectifs à maintenir en permanence (prévention ACSOS) :
...
- [ ] Mannitol 20% ou SSH si prescription (HTIC réfractaire)

## ⚠️ Points de vigilance

> [!danger] Hypotension = aggravation immédiate
...
1. **Prévenir les ACSOS** : PA, SpO₂, normocapnie, glycémie, température → l'IDE est le gardien de ces paramètres
2. **Jamais d'hypotonique** (sérum glucosé, Ringer, G5%) → aggrave l'œdème cérébral
3. **GCS + pupilles toutes les 30 min** → variation = appel immédiat

## 🔗 Voir aussi

[[Pathologies/HTIC\|HTIC]] · [[Pathologies/Coma\|Évaluation du coma]] · [[Pathologies/AVC hémorragique\|AVC hémorragique]] · [[Médicaments/Curares/Succinylcholine\|Succinylcholine]]

> [!caution] Outil pédagogique : Brain Trauma Foundation Guidelines 2016, recommandations SFAR/SRLF
