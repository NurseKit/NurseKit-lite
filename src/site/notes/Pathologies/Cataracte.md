---
{"dg-publish":true,"permalink":"/pathologies/cataracte/","tags":["pathologie","ophtalmologie","chirurgie"],"noteIcon":"","dg-note-properties":{"nom":"Cataracte","systeme":"Ophtalmologie","tags":["pathologie","ophtalmologie","chirurgie"],"revision":"2026-06-22"}}
---
...
|-------|--------|
| **BAV progressive** | Souvent bilatérale mais asymétrique → un œil plus atteint |
| **Éblouissement** | Brutal aux phares la nuit, difficulté à conduire |
| **Vision floue** | Sensation de brouillard ou de voile |
| "Deuxième vue" | Myopisation transitoire améliore la vision de près → trompeuse, ne dure pas |

## Rôle IDE

**Avant l'intervention :**
- [ ] Vérifier le dossier complet : bilan bio, consentement signé, arrêt des anticoagulants si prescrit
- [ ] Instiller les collyres pré-op selon protocole (dilatateur + antibiotique) → respecter impérativement les horaires
- [ ] Désinfection oculaire à la Bétadine ophtalmique

**Après l'intervention :**
- [ ] Mettre en place la **coque de protection oculaire** pour la nuit (protège contre les frottements involontaires)
...
> [!danger] Endophtalmie : urgence absolue
> Infection intra-oculaire post-opératoire. Triade à reconnaître : **rougeur progressive + douleur + baisse de vision** qui apparaît dans les jours suivant l'opération. Appeler le chirurgien immédiatement. Chaque heure compte pour sauver la vision.

> [!warning] Aucun médicament ne traite la cataracte
> Ni gouttes, ni compléments, ni vitamines. Si un patient demande "des gouttes pour la cataracte", la réponse est non : c'est la chirurgie ou rien. Éviter les faux espoirs.
...
[[Pathologies/DMLA\|DMLA]] · [[Pathologies/Glaucome\|Glaucome]] · [[Pathologies/Diabète de type 2\|Diabète type 2]] · [[Pathologies/Rétinopathie diabétique\|Rétinopathie diabétique]]
