---
{"dg-publish":true,"permalink":"/pathologies/menace-accouchement-premature/","tags":["pathologie","maternité","obstétrique","prématurité","grossesse"],"noteIcon":"","dg-note-properties":{"nom":"Menace d'Accouchement Prématuré (MAP)","systeme":"Maternité / Obstétrique","tags":["pathologie","maternité","obstétrique","prématurité","grossesse"],"revision":"2026-06-14"}}
---
...
- [ ] **Monitoring fœtal** (CTG) : fréquence cardiaque fœtale + tocographie (nombre/durée des CU)
- [ ] **Repos strict** au lit + position latérale gauche (décompression cave)
- [ ] Bilan : NFS, CRP, ECBU, prélèvement vaginal (recherche d'infection)
- [ ] **Tocolyse** selon prescription : nifédipine (Adalate® LP) PO ou atosiban (Tractocile®) IVSE → inhibe les contractions
- [ ] **Bétaméthasone** (Célestène®) 12 mg IM × 2 à 24 h d'intervalle si < 34 SA → maturation pulmonaire fœtale
- [ ] ATB si infection associée (chorioamniotite)
- [ ] Sulfate de magnésium IV si < 32 SA → neuroprotection fœtale
- [ ] Transfert in utero si terme < 32 SA → maternité de niveau III (néonatologie)
- [ ] Éducation : signes d'alerte, repos, arrêt de travail

## Points de vigilance

> [!danger] Chorioamniotite → accouchement immédiat
...
> [!danger] [[Pathologies/Rupture prématurée des membranes\|Rupture prématurée des membranes]] (RPM)
...
> [!warning] Bétaméthasone → effet sur la glycémie
...
[[Médicaments/Corticoïdes/Betamethasone\|Bétaméthasone]] · [[Médicaments/Minéraux/Magnesium\|[[Magnésium]] sulfate]]

> [!caution] Outil pédagogique : Recommandations CNGOF 2016. Toujours vérifier les prescriptions
