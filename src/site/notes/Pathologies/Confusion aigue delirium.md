---
{"dg-publish":true,"permalink":"/pathologies/confusion-aigue-delirium/","tags":["pathologie","gériatrie","neurologie","confusion","delirium"],"noteIcon":"","dg-note-properties":{"nom":"Syndrome confusionnel aigu (Delirium)","systeme":"Gériatrie","tags":["pathologie","gériatrie","neurologie","confusion","delirium"],"revision":"2026-06-22"}}
---
...
1. **Début aigu et fluctuant** : changement brutal par rapport à l'état de base, fluctuations dans la journée
2. **Inattention** : patient distrait, ne suit pas la conversation, ne maintient pas le fil
3. **Pensée désorganisée** : discours incohérent, idées sans lien, propos illogiques
4. **Altération du niveau de conscience** : de l'hypervigilance à la somnolence profonde
...
> [!warning] La forme hypoactive est la plus dangereuse car elle est fréquemment sous-diagnostiquée. Un patient calme et endormi peut être en delirium.
...
- [ ] Score CAM documenté dans le dossier à chaque évaluation
- [ ] Transmissions ciblées sur les fluctuations et les causes identifiées
- [ ] Signaler toute aggravation brutale au médecin

## Points de vigilance

> [!danger] Ne jamais interpréter une confusion comme "normale pour son âge". Toute confusion aiguë est une urgence diagnostique : chercher la cause selon PINCH ME.

> [!warning] La contention physique aggrave l'agitation et le delirium, augmente le risque de chutes et de décès. Elle doit être évitée autant que possible et, si prescrite médicalement, réévaluée toutes les 24h.

> [!warning] Les benzodiazépines aggravent le delirium (sauf delirium tremens / sevrage alcoolique). Ne pas en administrer sans prescription médicale explicite dans ce contexte.

## Les 3 choses à retenir

1. **Le delirium est toujours le signe d'une cause sous-jacente** : utiliser PINCH ME pour la rechercher systématiquement.
2. **Le score CAM est l'outil de référence** : diagnostic si critères 1 + 2 + (3 ou 4), à évaluer à chaque poste.
3. **La forme hypoactive est la plus souvent manquée** : un patient calme, somnolent et mutique peut être en delirium sévère.
