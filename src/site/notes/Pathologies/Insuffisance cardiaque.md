...
- [ ] Scope : TA, FC, SpO₂, FR → noter et comparer aux valeurs habituelles du patient
- [ ] Bilan entrées/sorties si décompensation → les diurétiques ne font leur effet que si on mesure la diurèse
- [ ] Restriction hydrique si prescrite (généralement < 1,5 L/j si hyponatrémie)
- [ ] Furosémide IV si décompensation sur prescription → surveiller kaliémie (déplétion rapide)
- [ ] Éducation patient : régime hyposodé (< 4 g NaCl/j), poids quotidien à domicile, reconnaître les signes d'alerte
- [ ] Vérifier l'observance de la quadrithérapie (IEC/ARNI + bêtabloquant + spironolactone + iSGLT2)

> [!info] Acronyme EPOF : ETP insuffisance cardiaque
> **E**ssoufflement : toute aggravation → appeler le médecin
> **P**oids : peser chaque matin → alerter si **+ 2 kg en 2 jours** ou **+ 3 kg en 1 semaine**
...
> [!warning] Décompensation : signaux d'alarme
