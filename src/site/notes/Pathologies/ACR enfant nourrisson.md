...
> 2. **5 insufflations initiales** : bouche-à-bouche ou masque adapté (observer le soulèvement thoracique)
> 3. **Évaluer la circulation** (pouls, signes de vie) : 10 secondes max
> 4. Si absent : **30 compressions + 2 insufflations** (secouriste seul) ou **15:2** (2 secouristes formés)
...
> [!info] Conduite IDE pendant la RCP
...
> | 4H | 4T |
> |---|---|
> | **H**ypoxie | **T**amponnade |
> | **H**ypovolémie | Pneumo**t**horax sous tension |
