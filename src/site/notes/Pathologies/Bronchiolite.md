---
{"dg-publish":true,"permalink":"/Pathologies/Bronchiolite/","tags":["pathologie","pédiatrie","pneumologie","nourrisson","VRS"],"noteIcon":"","dg-note-properties":{"nom":"Bronchiolite Aiguë du Nourrisson","systeme":"Pédiatrie / Pneumologie","tags":["pathologie","pédiatrie","pneumologie","nourrisson","VRS"],"revision":"2026-06-14"}}
---
...
- [ ] **Désobstruction rhinopharyngée (DRP)** → NaCl 0,9% en lavage nasal avant chaque repas → clé du traitement
- [ ] Positionnement : proclive 30°, tête droite dans l'axe (pas d'oreiller chez nourrisson)
- [ ] Surveillance respiratoire : FR, SpO₂ en continu si hospitalisation, signes de lutte
- [ ] Surveillance de la prise alimentaire : si < 50% du repas habituel → hospitalisation
- [ ] Fractionner les repas (petites quantités souvent) → moins de dyspnée pendant la tétée
- [ ] Humidification nasale + aspiration douce des sécrétions si nécessaire
- [ ] O₂ si SpO₂ < 92% → lunettes nasales ou masque
- [ ] HFNO (Optiflow®) si forme sévère → remplace souvent la CPAP
- [ ] Pas d'ATB (viral), pas de corticoïdes, pas de bronchodilatateurs (inefficaces en première intention)

## ⚠️ Points de vigilance

> [!danger] Apnées → urgence vitale
...
> [!warning] Déshydratation par refus alimentaire
...
> [!caution] Kinésithérapie respiratoire
...
1. **DRP au NaCl** avant chaque repas → traitement de base, efficace et sans risque
2. **SpO₂ < 92% ou apnées → hospitalisation** urgente
3. **Pas d'ATB** : c'est viral → antibiotiques inutiles et délétères
