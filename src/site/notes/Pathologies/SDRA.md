---
{"dg-publish":true,"permalink":"/pathologies/sdra/","tags":["pathologie","réanimation","respiratoire","ventilation"],"noteIcon":"","dg-note-properties":{"nom":"SDRA - Syndrome de Détresse Respiratoire Aiguë","systeme":"Réanimation / Pneumologie","tags":["pathologie","réanimation","respiratoire","ventilation"],"revision":"2026-06-22"}}
---
...
- [ ] Préparer l'intubation si prescrite : chariot d'intubation, laryngoscope, sondes IOT, médicaments de séquence rapide (étomidate/kétamine + succinylcholine)
- [ ] Installer la ventilation mécanique selon prescription : VT 6 mL/kg poids idéal, PEEP selon protocole
- [ ] Surveiller les paramètres ventilatoires : pression de plateau < 30 cmH₂O, PEEP, FiO₂, VT réel
- [ ] **Décubitus ventral si prescrit** : positionnement en équipe (5 personnes minimum), protection des points d'appui (front, joues, genoux), durée 16 h minimum
- [ ] Bilan des GDS (gaz du sang) selon prescription → PaO₂/FiO₂ de suivi
- [ ] Bilan entrées/sorties strict : le patient SDRA est souvent en surcharge hydrique → objectif balance neutre ou négative
- [ ] Soins de bouche toutes les 4-6 h (prévention PAVM)
...
> [!caution] Outil pédagogique : ARDS Network Protocol, PROSEVA trial, recommandations SRLF
