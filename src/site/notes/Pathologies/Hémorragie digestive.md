...
- [ ] **VVP × 2 de gros calibre** en urgence + prélèvements simultanés (NFS, groupe/RAI, TP/TCA, ionogramme)
- [ ] Scope continu : TA et FC toutes les 15 min, SpO₂
- [ ] **À jeun strict** → la FOGD est urgente, aucun aliment ou liquide avant
- [ ] Surveiller et noter : vomissements (quantité, aspect), selles (méléna, rectorragies)
- [ ] Diurèse (sonde urinaire si choc ou signes de choc)
- [ ] Préparer la transfusion selon prescription (contrôle ultime au lit du patient obligatoire)
- [ ] Préparer le chariot d'urgence à proximité
...
> [!warning] Récidive hémorragique après FOGD
