...
|-------|--------|
| I | Cutané seul : urticaire, prurit, érythème, angiœdème → surveiller, ça peut évoluer vite |
| II | Cutané + respiratoire (dyspnée, sibilants) ou cardiovasculaire (hypotension modérée) → adrénaline ! |
| III | **Choc** : hypotension sévère, détresse respiratoire, bronchospasme majeur → adrénaline en urgence vitale |
| IV | **Arrêt cardiorespiratoire** → RCP + adrénaline IV |
...
> 2. **Adrénaline IM 0,3-0,5 mg dans la cuisse antérolatérale** → IMMÉDIATEMENT, c'est le seul traitement qui sauve
> 3. **Position** : allonger avec jambes surélevées si choc ; assis si dyspnée prédominante
> 4. **O₂ haut débit** : masque haute concentration à 15 L/min
> 5. **VVP** + remplissage NaCl 0,9 % 500 mL si hypotension
> 6. **Scope continu** : TA, FC, SpO₂
> 7. **2e injection adrénaline** à 5-15 min si pas d'amélioration nette
...
> [!danger] Réaction biphasique
> 10-20 % des anaphylaxies récidivent 4 à 12h plus tard, sans nouveau contact avec l'allergène. C'est pour ça que la surveillance minimum de 4-8h est non négociable, même quand tout semble rentré dans l'ordre.
