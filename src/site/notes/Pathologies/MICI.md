...
- [ ] Évaluer et tracer la fréquence des selles, leur aspect (sang, glaires), la douleur abdominale (EVA)
- [ ] Surveillance nutritionnelle : poids quotidien, apports alimentaires, signes de dénutrition (albuminémie, CRP)
- [ ] Bilan biologique : NFS (anémie, polynucléose), CRP (marqueur d'activité), albumine, bilan martial (carence martiale fréquente), calprotectine fécale
- [ ] Traitements biologiques (anti-TNF : infliximab, adalimumab ; vedolizumab, ustekinumab) : surveillance des réactions à la perfusion, dépistage tuberculose avant instauration
- [ ] Immunosuppresseurs (azathioprine, 6-mercaptopurine) : NFS régulière (leucopénie), hépatotoxicité
- [ ] Corticothérapie en poussée : surveillance glycémie, TA, poids, signes infectieux
- [ ] ETP : expliquer l'évolution par poussées/rémissions, les facteurs déclenchants (stress, AINS, tabac pour Crohn), l'importance de l'observance

## Points de vigilance

> [!danger] Mégacôlon toxique (RCH)
