---
{"dg-publish":true,"permalink":"/Pathologies/Acidocetose diabetique/","tags":["pathologie","métabolique","diabète","urgence"],"noteIcon":"","dg-note-properties":{"nom":"Acidocétose diabétique","systeme":"Métabolique","tags":["pathologie","métabolique","diabète","urgence"],"revision":"2026-06-13"}}
---
...
|-------|--------|
| **Syndrome cardinal (3P)** | Polyurie, polydipsie, polyphagie |
| **Nausées, vomissements** | + douleurs abdominales qui peuvent mimer une urgence chir |
| **Dyspnée de Kussmaul** | Respiration profonde, ample, rapide → le corps souffle le CO₂ pour compenser |
| **Haleine acétonique** | Odeur sucrée-fruitée, pomme ou vernis à ongles → une fois sentie, jamais oubliée |
| **Déshydratation** | Tachycardie, muqueuses sèches, pli cutané |
| **Troubles de conscience** | Du ralentissement au coma → signe de gravité majeure |
...
- [ ] Surveiller les signes d'hypokaliémie : crampes, faiblesse musculaire, modifications ECG (onde T aplatie ou inversée)
- [ ] Ionogramme régulier selon prescription → le K+ est la valeur à ne jamais rater
...
> [!warning] Maladie + insuline = augmenter l'insuline, pas la stopper
> Un patient DT1 avec grippe ou infection qui arrête son insuline "parce qu'il ne mange pas" : erreur fréquente et dangereuse. Le stress infectieux augmente les besoins en insuline.
