...
- [ ] **Aspiration sous-glottique** continue si sonde équipée (SGA) → vider les sécrétions piégées au-dessus du ballonnet
- [ ] **Soins de bouche** toutes les 4-6 h avec chlorhexidine 0,12% → réduit la colonisation oropharyngée (protocole validé)
- [ ] **Hygiène des mains** stricte SHA avant et après tout contact avec les voies aériennes
- [ ] **Circuit respiratoire** : ne jamais laisser de l'eau se condenser et couler vers le patient (retourner les condensats vers les coupelles collectrices)
- [ ] Pas de changement systématique du circuit (changer seulement si souillé ou défectueux)
- [ ] Sevrage ventilatoire quotidien évalué : évaluer chaque matin si extubation possible → chaque jour sous VM = risque PAVM supplémentaire
...
> [!warning] Pression du ballonnet à surveiller
