...
Causes : [[Pathologies/AVC hémorragique\|AVC hémorragique]], traumatisme crânien grave, [[Pathologies/AVC ischémique\|AVC ischémique]] malin, méningite, encéphalite, hydrocéphalie, tumeur.
...
| [[Médicaments/Normes/Glasgow\|Glasgow]] qui chute | Signe de gravité, à surveiller en continu |
...
- [ ] **Position : tête à 30°**, dans l'axe du corps (ne jamais tourner la tête de côté → compression jugulaire)
- [ ] Scope continu : TA, FC, FR, SpO₂, température, [[Médicaments/Normes/Glasgow\|Glasgow]] toutes les heures
- [ ] Surveiller le **Glasgow** → baisse de 2 points = appel médecin immédiat
- [ ] Surveiller les pupilles : taille, symétrie, réactivité à la lumière → toutes les heures en réa
- [ ] Objectif **PAM ≥ 80 mmHg** (pour assurer PPC ≥ 60 mmHg si PIC à 20) → ne jamais laisser la TA chuter
- [ ] Éviter tout ce qui augmente la PIC :
...
- [ ] Si capteur de PIC posé : noter les valeurs, alerter si PIC > 20 mmHg persistant
- [ ] Mannitol 20% ou SSH (sérum salé hypertonique) si prescrit → perfusion rapide sur prescription
- [ ] Dexaméthasone si HTIC sur tumeur ou abcès (pas si trauma)
- [ ] Bilan neurologique complet à chaque relève : GCS, pupilles, déficits moteurs/sensitifs, convulsions
- [ ] Prévention : hyperthermie traitée dès 38°C, glycémie surveillée, pas d'hyperventilation sauf engagement

## Points de vigilance

> [!danger] Mydriase unilatérale = engagement temporal
...
> [!warning] Aspiration trachéale prudente
...
[[Pathologies/AVC hémorragique\|AVC hémorragique]] · [[Pathologies/Méningite\|Méningite]] · [[Pathologies/Coma\|Évaluation du coma]] · [[Médicaments/Corticoïdes/Dexamethasone\|Dexaméthasone]]

> [!caution] Outil pédagogique : recommandations SRLF/SFAR, Brain Trauma Foundation Guidelines
