...
> [!warning] Pièges comportementaux à éviter absolument
...
- [ ] Identifier le déclencheur des SPCD avant d'agir : douleur ? faim ? environnement bruyant ? Souvent un besoin non exprimé
- [ ] Surveiller la dénutrition (poids hebdomadaire), la déshydratation et la douleur → évaluation avec DOLOPLUS-2 ou ALGOPLUS car le patient ne peut plus toujours verbaliser
- [ ] Prévention des complications : escarres (Braden), chutes (Morse), infections urinaires et pulmonaires
- [ ] Médicaments avec vigilance → la déglutition peut être altérée, écraser si nécessaire mais vérifier la formulation galénique
