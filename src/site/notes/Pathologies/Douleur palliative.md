---
{"dg-publish":true,"permalink":"/Pathologies/Douleur palliative/","tags":["pathologie","soins-palliatifs","douleur","oncologie","fin-de-vie"],"noteIcon":"","dg-note-properties":{"nom":"Douleur en Soins Palliatifs","systeme":"Soins Palliatifs / Oncologie","tags":["pathologie","soins-palliatifs","douleur","oncologie","fin-de-vie"],"revision":"2026-06-14"}}
---
...
- **Neuropathique** : compression nerveuse, envahissement plexique → brûlures, décharges électriques
- **Existentielle** : angoisse de mort, sentiment d'abandon, deuil anticipé
...
| Outil | Usage |
|-------|-------|
| EVA/EN | Patient communicant |
| ALGOPLUS | Patient non communicant âgé |
| DOLOPLUS-2 | Patient dément ou non communicant |
| BPS | Patient en réanimation |
| Fréquence | Douleur de fond + accès douloureux paroxystiques (ADP) |
...
- [ ] Antalgiques de fond : adapter la voie (PO → SC → IV selon l'évolution)
- [ ] **Accès douloureux paroxystiques (ADP)** : morphine à action rapide d'emblée (1/6e de la dose quotidienne en interdose)
- [ ] Prévention de la douleur procédurale : prémédication 30 min avant les soins (morfine SC, MEOPA)
- [ ] Traitements adjuvants neuropathiques : gabapentine, amitriptyline, kétamine à faibles doses
- [ ] Mesures non médicamenteuses : positionnement, chaleur locale, massages, présence, écoute
