---
{"dg-publish":true,"permalink":"/Pathologies/Parkinson/","tags":["pathologie","neurologie","chronique","mouvement"],"noteIcon":"","dg-note-properties":{"nom":"Maladie de Parkinson","systeme":"Neurologie","tags":["pathologie","neurologie","chronique","mouvement"],"revision":"2026-06-13"}}
---
...
|-------|--------|
| **Tremblement de repos** | Rythmique, asymétrique, "pill-rolling", disparaît au mouvement volontaire |
| **Rigidité** | "Roue dentée" à la mobilisation passive |
| **Akinésie/Bradykinésie** | Lenteur, petits pas, hypomimie (visage figé), micrographie (écriture de fourmis) |
...
- [ ] Surveiller la déglutition : dysphagie fréquente → textures adaptées, position assise à 90° pendant les repas et 30 min après
- [ ] Dépister et traiter la constipation (fréquente, aggravée par la réduction de mobilité et certains anti-parkinsoniens)
