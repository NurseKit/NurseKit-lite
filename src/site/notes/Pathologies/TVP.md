...
- [ ] Mobilisation non contre-indiquée si anticoagulation en place (le repos strict n'est plus recommandé)
- [ ] Surveiller les signes d'embolie pulmonaire : dyspnée brutale, douleur thoracique, tachycardie → appel immédiat
- [ ] Sous HBPM : NFS-plaquettes à J5 et J10 (dépistage TIH) ; surveiller la fonction rénale

## ⚠️ Points de vigilance

> [!danger] Signes d'embolie pulmonaire : appel urgent
...
1. **"Wells d'abord, toujours"** → avant les examens, le score oriente : probabilité faible → D-Dimères ; probabilité forte → écho-Doppler direct (les D-Dimères seront positifs de toute façon, inutile de les demander)
2. **"D-Dimères négatifs = TVP exclue"** → mais seulement si probabilité faible/modérée ; D-Dimères positifs ne veulent rien dire de spécifique (grossesse, infection, post-op...)
3. **"Surveille les signes d'EP"** → le vrai danger de la TVP c'est la migration : toute dyspnée ou tachycardie impose un appel médecin immédiat
