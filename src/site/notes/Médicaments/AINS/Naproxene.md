...
> IEC/ARA2 + diurétique + naproxène = risque d'insuffisance rénale aiguë. Vérifier l'ordonnance → surtout chez les patients âgés hypertendus.

> [!caution] Prudence
> - Sujet âgé → dose minimale, durée courte, IPP associé
> - Coronaropathie en traitement prolongé → alternative à discuter avec le médecin
> - Grossesse 1er-2e trimestre : déconseillé même si moins formel que le 3e trimestre
...
- [ ] Associer un IPP si prescrit (surtout sujet âgé ou antécédent d'ulcère)
...
3. **Triade néphrotoxique et 3e trimestre grossesse** = CI comme pour tous les AINS
