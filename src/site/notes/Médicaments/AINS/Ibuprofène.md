---
{"dg-publish":true,"permalink":"/Médicaments/AINS/Ibuprofène/","tags":["médicament","AINS","antalgique","antiinflammatoire","palier1"],"noteIcon":"","dg-note-properties":{"nom":"Ibuprofène","classe":["AINS","Anti-inflammatoire","Antalgique palier 1"],"indications":["Douleur avec composante inflammatoire (entorse, arthrite, règles douloureuses)","Fièvre","Maux de tête, migraine"],"posologie":"200-400 mg toutes les 6-8h · Max 1200 mg/j (automédication) ou 2400 mg/j (prescription) · Toujours prendre avec un repas","contre_indications":["Ulcère gastroduodénal actif","Insuffisance rénale sévère","Insuffisance cardiaque sévère","Grossesse ≥ 6 mois (CI absolue)","Allergie AINS/aspirine"],"effets_secondaires":["Douleurs d'estomac, ulcère (risque principal)","Insuffisance rénale aiguë","Hypertension artérielle","Rétention d'eau"],"service":["Médecine générale","Urgences","Rhumatologie","Gynécologie"],"mécanisme":"Bloque l'inflammation en inhibant des enzymes qui fabriquent les molécules de l'inflammation (prostaglandines)","interactions":["Aspirine : éviter l'association (double risque gastrique)","AVK : augmente l'effet anticoagulant","Diurétiques : peut réduire leur efficacité et abîmer les reins"],"niveau_preuve":"A","tags":["médicament","AINS","antalgique","antiinflammatoire","palier1"],"revision":"2026-06-13"}}
---
...
> [!caution] Gastroprotection si traitement prolongé
> Si l'ibuprofène est pris plusieurs jours d'affilée → associer un protecteur gastrique ([[Médicaments/Antiacides/Omeprazole\|oméprazole]]) pour protéger l'estomac. En pratique, au-delà de 3 jours, on en parle au médecin.
...
- [ ] Rappeler au patient de **prendre pendant un repas**, pas juste avec un verre d'eau
- [ ] Si traitement > 3 jours → vérifier si un [[Médicaments/Antiacides/Omeprazole\|IPP]] est prescrit en protection gastrique
- [ ] **Surveiller** : douleur épigastrique, selles noires → méléna = urgence digestive
- [ ] **Insuffisant rénal, cardiaque ou hypertendu** → signaler au médecin (risque d'aggravation)
