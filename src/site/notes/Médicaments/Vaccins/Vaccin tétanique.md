...
> - Revaccination trop précoce (< 5 ans depuis la dernière dose) → réaction d'Arthus (érythème étendu douloureux)

> [!warning] Précautions
> - Maladie aiguë fébrile : reporter si possible
> - Vérifier le calendrier avant tout rappel post-exposition
...
|-----------------|-------------|---------------------------------------|
| Vacciné < 5 ans | Rien | Rien |
| Vacciné 5-10 ans | Rien | 1 rappel vaccin |
| Vacciné > 10 ans | 1 rappel | 1 rappel + Ig tétaniques (250 UI IM) |
| Non vacciné | 1 dose + compléter | 1 dose + Ig (250 UI IM) |

- [ ] Vérifier le carnet de vaccination (date dernier rappel)
- [ ] Injection IM au deltoïde
...
> 2. Plaie souillée + dernière dose > 5 ans → **rappel obligatoire** (> 10 ans → rappel + Ig)
> 3. Ne pas rappeler si < 5 ans depuis la dernière dose (réaction d'Arthus douloureuse)
