...
> - Réaction anaphylactique à une dose précédente

> [!warning] Précautions
> - Maladie aiguë fébrile sévère : reporter (pas une CI absolue)
> - Immunosuppresseurs : réponse réduite, vacciner quand même
...
- [ ] **Surveillance 15 min** après injection (anaphylaxie)
...
> 2. CI allergie sévère à l'œuf → vaccin **cellulaire** (Optaflu®) en remplacement
> 3. Chez ≥ 65 ans : préférer **Efluelda®** (haute dose) ou **Fluad®** (adjuvanté) pour une meilleure protection
