...
> - Rappel si < 5 ans depuis la dernière dose (réaction d'Arthus : érythème étendu douloureux)
...
| Vacciné > 10 ans | 1 rappel | 1 rappel + Ig (250 UI IM) |
| Non vacciné | 1 dose + compléter | 1 dose + Ig (250 UI IM) |

- [ ] Vérifier le carnet (date dernier rappel)
...
> 2. Plaie souillée + dernière dose > 5 ans → **rappel obligatoire** (> 10 ans → rappel + Ig tétaniques)
> 3. Ne jamais rappeler si < 5 ans (réaction d'Arthus douloureuse)
