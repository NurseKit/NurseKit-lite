...
> [!danger] Voie centrale OBLIGATOIRE
...
> [!danger] Extravasation = urgence absolue
...
- [ ] VVC avant démarrage → vérifier la position et la perméabilité
- [ ] Monitorage invasif : cathéter artériel (PA continue), scope ECG
- [ ] Objectif PAM ≥ 65 mmHg (ou 70-75 chez hypertendu chronique)
- [ ] Inspecter le site VVC régulièrement (rougeur, gonflement = STOP + appel)
- [ ] Surveiller les extrémités : coloration, chaleur, capillarité
- [ ] Diurèse horaire (sonde urinaire, reflet perfusion rénale)
...
- [[Pathologies/Sepsis\|Sepsis]] · [[Pathologies/Choc anaphylactique\|Choc anaphylactique]]
