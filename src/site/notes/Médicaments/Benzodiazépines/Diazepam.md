---
{"dg-publish":true,"permalink":"/Médicaments/Benzodiazépines/Diazepam/","tags":["médicament","benzodiazépine","anxiolytique","antiépileptique","sevrage_alcoolique","urgences"],"noteIcon":"","dg-note-properties":{"nom":"Diazépam","classe":["Benzodiazépine","Anxiolytique","Antiépileptique","Myorelaxant"],"indications":["Anxiété sévère (court terme ≤ 4 semaines)","Sevrage alcoolique (CIWA → traitement de référence)","État de mal épileptique (IV/IR)","Convulsions fébriles de l'enfant (IR)","Contractures musculaires","Prémédication anesthésique","Agitation aiguë"],"posologie":"Anxiété : 2-10 mg x2-3/j PO. Sevrage alcoolique : 10-20 mg PO/4-6h selon score CIWA. IV : 5-10 mg lentement (état de mal épileptique). IR : 5 mg si < 15 kg ; 10 mg si > 15 kg (enfant)","contre_indications":["Insuffisance respiratoire sévère non assistée","Insuffisance hépatique sévère","Myasthénie","SAOS non appareillé","Grossesse (fente palatine T1, syndrome de sevrage néonatal)"],"effets_secondaires":["Sédation, somnolence","Dépression respiratoire (IV++)","Amnésie antérograde","Dépendance physique et psychique (traitement > 4 semaines)","Syndrome de sevrage (arrêt brutal : crise convulsive possible)","Tolérance","Chutes (personnes âgées)","Confusion, réaction paradoxale (sujet âgé)"],"service":["Urgences","Anesthésie","Neurologie","Addictologie","Médecine interne"],"mécanisme":"Agoniste allostérique positif des récepteurs GABA-A : se fixe sur le site benzodiazépine et augmente la fréquence d'ouverture du canal chlore en réponse au GABA → hyperpolarisation neuronale → inhibition du SNC. Demi-vie très longue (20-100h) + métabolite actif (nordazépam) → accumulation possible.","interactions":["Opioïdes → dépression respiratoire sévère (CI en IV hors réanimation)","Alcool, antipsychotiques, antihistaminiques → sédation additive","Inhibiteurs CYP3A4 (azolés, érythromycine) → ↑ diazépam","Inducteurs CYP3A4 (carbamazépine, rifampicine) → ↓ diazépam"],"niveau_preuve":"A","tags":["médicament","benzodiazépine","anxiolytique","antiépileptique","sevrage_alcoolique","urgences"],"revision":"2026-06-13"}}
---
...
> [!warning] Ce qui ne se négocie pas
...
> [!caution] À surveiller en cours d'utilisation
...
- [ ] **Sevrage alcoolique** : évaluer le score CIWA avant chaque dose, adapter les doses au score, ne pas laisser le patient seul les premières heures → les convulsions de sevrage peuvent arriver vite
- [ ] Surveiller la somnolence excessive et le risque de chute, en particulier chez les personnes âgées
- [ ] Expliquer au patient : durée ≤ 4 semaines, jamais d'arrêt brusque seul
- [ ] Si traitement > 4 semaines : décroissance progressive, réduction de 10-25% par semaine maximum
...
3. **"IV lente + surveillance SpO₂"** → max 5 mg/min ; même à dose correcte, la dépression respiratoire est possible surtout si association avec un opioïde
