...
> [!warning] Hypotension à l'induction
...
> [!caution] Triglycérides et apport calorique
...
- [ ] Évaluer le RASS toutes les 2-4 h → cible prescrite (souvent -2 à -3 en réa)
- [ ] Surveiller TA toutes les 15 min à l'initiation (risque hypotension)
- [ ] Ne jamais dépasser 4 mg/kg/h sur plus de 48 h
- [ ] Agiter doucement la seringue ou le flacon avant utilisation (émulsion peut se séparer)
- [ ] Ne pas mélanger dans la même seringue avec d'autres médicaments
- [ ] Changer la seringue/tubulure toutes les 12 h (risque infectieux sur émulsion lipidique)
- [ ] Penser à l'analgésie : le propofol ne soulage pas la douleur (toujours associer un opioïde en réa)
- [ ] Surveiller le RASS et évaluer quotidiennement si une interruption de sédation est possible ("Spontaneous Awakening Trial")
