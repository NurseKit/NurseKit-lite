---
{"dg-publish":true,"permalink":"/medicaments/mineraux/fer/","tags":["médicament","minéral","fer","anémie_ferriprive","selles_noires_bénin","jeun_optimal"],"noteIcon":"","dg-note-properties":{"nom":"Fer","classe":["Minéral","Supplément en fer"],"indications":["Anémie ferriprive (carence martiale)","Syndrome des jambes sans repos (fer-dépendant)","Prématurité"],"posologie":"PO : Tardyferon® 80 mg/j (à jeun de préférence) · IV : Ferinject® 500-1000 mg IV sur 15 min","contre_indications":["Anémie non ferriprive (erreur diagnostique → risque surcharge)","Hémochromatose"],"effets_secondaires":["PO : constipation, **selles noires** (bénin → à expliquer), nausées, épigastralgies","IV : réactions allergiques (rare)"],"service":["Médecine générale","Hématologie","Gastroentérologie"],"niveau_preuve":"A","tags":["médicament","minéral","fer","anémie_ferriprive","selles_noires_bénin","jeun_optimal"],"revision":"2026-06-22"}}
---
...
> - Hémochromatose : CI absolue

> [!warning] Précautions
> - IV : ne pas injecter en bolus pur (sauf protocole spécifique)
> - Espacer du lait, thé, café, antiacides de 2h (réduisent l'absorption)
...
- [ ] Éviter thé, café, lait dans les 2h après la prise
...
> 2. Prise à **jeun avec vitamine C** (jus de citron) → absorption maximale → avec le repas si mauvaise tolérance
> 3. Traitement **3 mois minimum** après normalisation de l'Hb pour reconstituer les réserves
