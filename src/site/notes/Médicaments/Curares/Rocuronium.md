---
{"dg-publish":true,"permalink":"/Médicaments/Curares/Rocuronium/","tags":["médicament","curare","réanimation","intubation","SDRA"],"noteIcon":"","dg-note-properties":{"nom":"Rocuronium (Esmeron®)","classe":["Curare non dépolarisant","Myorelaxant","Bloqueur neuromusculaire"],"indications":["Intubation oro-trachéale (RSI si succinylcholine contre-indiquée)","Curarisation en réanimation (SDRA sévère, VM difficile)","Facilitation de l'intubation difficile"],"posologie":"RSI : 1,2 mg/kg IV (action en 60 sec à cette dose). Intubation classique : 0,6 mg/kg IV. Entretien réa : 0,3-0,6 mg/kg/h IVSE selon TOF","contre_indications":[{"Allergie au rocuronium (attention":"risque de réaction croisée avec le suggamadex)"},"Myasthénie grave (extrême sensibilité)"],"effets_secondaires":["Allergie (peut être grave)","Curarisation résiduelle si pas de décurarisation","Tachycardie légère","Curarisation prolongée si insuffisance hépatique (métabolisme hépatique)"],"service":["Réanimation","Anesthésie","Urgences"],"mécanisme":"Compétiteur de l'acétylcholine sur les récepteurs nicotiniques de la plaque motrice → bloque la transmission neuromusculaire SANS fasciculations préalables (non dépolarisant). Antidote spécifique = suggamadex (encapsule le rocuronium)","interactions":["Suggamadex (Bridion®) : antidote spécifique → neutralisation complète en 3 min (16 mg/kg si RSI à 1,2 mg/kg)","Aminosides, halogénés : potentialisent le bloc neuromusculaire","Corticoïdes au long cours : risque de myopathie de réanimation si association prolongée"],"niveau_preuve":"A","tags":["médicament","curare","réanimation","intubation","SDRA"],"revision":"2026-06-14"}}
---
...
> [!warning] Myopathie de réanimation
...
> [!caution] Suggamadex et allergie
...
- [ ] En curarisation IVSE : brancher le monitorage TOF si disponible (4 stimulations électriques sur le nerf cubital → compter les contractions)
- [ ] Évaluer quotidiennement la nécessité de poursuivre la curarisation
- [ ] Avoir le suggamadex disponible dans l'unité : **16 mg/kg IV** si urgence de décurarisation après RSI à 1,2 mg/kg
- [ ] Surveiller : FC, TA, absence de mouvements parasites sous VM (signe de curarisation insuffisante)
- [ ] Soins particuliers chez le patient curarisé : soins oculaires (absence du réflexe cornéen), prévention escarres, soins de bouche
