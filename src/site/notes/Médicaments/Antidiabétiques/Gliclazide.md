---
{"dg-publish":true,"permalink":"/Médicaments/Antidiabétiques/Gliclazide/","tags":["médicament","antidiabétique","sulfamide","gliclazide","hypoglycémie"],"noteIcon":"","dg-note-properties":{"nom":"Gliclazide","classe":["Antidiabétique oral","Sulfamide hypoglycémiant (2ème génération)"],"indications":["Diabète de type 2 (DT2) en 2ème ligne après metformine","DT2 avec intolérance ou CI à la metformine"],"posologie":"Forme LP : 30-120 mg/j en 1 prise le matin au petit-déjeuner · Forme standard : 80-320 mg/j en 2 prises","contre_indications":["Diabète de type 1 (DT1)","Insuffisance rénale sévère (DFG < 30 mL/min)","Insuffisance hépatique sévère","Grossesse et allaitement","Hypersensibilité aux sulfamides"],"effets_secondaires":["Hypoglycémie (risque principal ++)","Prise de poids","Troubles digestifs (nausées, diarrhées)","Réaction allergique cutanée (rare)"],"service":["Médecine interne","Endocrinologie","Tous services (patient DT2 hospitalisé)"],"mécanisme":"Stimule la sécrétion d'insuline par les cellules bêta du pancréas en bloquant les canaux K+-ATP → dépolarisation → libération d'insuline indépendamment de la glycémie","interactions":["Alcool : potentialise l'hypoglycémie (inhibe la néoglucogenèse hépatique)","AINS, aspirine forte dose : potentialisent l'effet hypoglycémiant","Bêtabloquants : masquent les signes sympathiques de l'hypoglycémie (tachycardie)","Fluconazole, miconazole : augmentent le taux plasmatique → risque hypoglycémie","Corticoïdes : effet hyperglycémiant → déséquilibre du diabète"],"niveau_preuve":"A","tags":["médicament","antidiabétique","sulfamide","gliclazide","hypoglycémie"],"revision":"2026-06-14"}}
---
...
> [!danger] Hypoglycémie : risque principal ++
