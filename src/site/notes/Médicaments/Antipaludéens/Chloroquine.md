---
{"dg-publish":true,"permalink":"/Médicaments/Antipaludéens/Chloroquine/","tags":["médicament","antipaludéen","rétinopathie","résistances_majeures"],"noteIcon":"","dg-note-properties":{"nom":"Chloroquine","classe":["Antipaludéen","Antiparasitaire"],"indications":["Prophylaxie antipaludique dans les rares zones encore sensibles (Amérique centrale, Caraïbes)","Traitement paludisme à P. vivax, P. ovale, P. malariae (zones sensibles)","Amibiase extra-intestinale hépatique (2ème ligne)"],"posologie":"Prophylaxie : 300 mg base/semaine (Nivaquine® 100 mg base = 1 cp à 155 mg de chloroquine phosphate). Débuter 1 sem avant et continuer 4 sem après retour. Traitement : 25 mg/kg sur 3j (10/7,5/7,5 mg/kg)","contre_indications":["Rétinopathie préexistante","Psoriasis (décompensation grave possible)","Épilepsie (abaissement du seuil épileptogène)","Association méfloquine (↑ convulsions + allongement QT)","Allongement QT connu"],"effets_secondaires":["Rétinopathie (dose-cumulée irréversible → risque dès 200g cumulé)","Allongement QT (surveiller ECG si risque)","Troubles digestifs (nausées, diarrhées)","Prurit intense (Afrique subsaharienne → très fréquent, mécanisme incertain)","Décompensation psoriasis"],"service":["Médecine des voyages","Médecine interne"],"mécanisme":"Accumulation dans la vacuole digestive du parasite → ↑ pH → inhibition polymérisation hème → hème libre toxique pour le parasite. N'agit plus sur P. falciparum (résistances massives en Afrique sub-saharienne, Asie, Amérique du Sud)","interactions":["Antiacides (↓ absorption → espacer 4h)","Méfloquine (CI → ↑ convulsions + QT)","Amiodarone, halopéridol (↑ QT)","Ciclosporine (↑ ciclosporinémie)"],"niveau_preuve":"A (zones sensibles)","tags":["médicament","antipaludéen","rétinopathie","résistances_majeures"],"revision":"2026-06-13"}}
---
...
- Prophylaxie antipaludique en zone sensible
- Traitement du paludisme à *P. vivax*, *P. ovale*, *P. malariae* (pas *P. falciparum*, résistant en pratique partout en Afrique et Asie)
- Amibiase hépatique (infection parasitaire du foie)
...
- [ ] Informer sur la durée : commencer 1 sem avant le départ, continuer **4 semaines après le retour** (attention à ne pas confondre avec Malarone® qui est 7j seulement)
- [ ] Fond d'œil avant traitement prolongé, puis annuellement
- [ ] Espacer les antiacides de 4h
...
- [[Médicaments/Antipaludéens/Mefloquine\|Méfloquine]] · HCSP recommandations antipaludéens 2024
