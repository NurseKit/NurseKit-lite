---
{"dg-publish":true,"permalink":"/Médicaments/Antipsychotiques/Haloperidol/","tags":["médicament","antipsychotique","neuroleptique","psychiatrie","urgences","agitation","SMN"],"noteIcon":"","dg-note-properties":{"nom":"Halopéridol","classe":["Antipsychotique typique (1ère génération)","Neuroleptique","Butyrophénone"],"indications":["Schizophrénie (phases aiguës et entretien)","Épisode maniaque aigu","Agitation psychomotrice aiguë (psychiatrique)","Délire aigu","Syndrome confusionnel avec agitation (gériatrie → hors AMM)","Nausées/vomissements rebelles (faibles doses)","Chorée de Huntington"],"posologie":"PO : 2-20 mg/j en 2-3 prises. IM : 5-10 mg (répétable 30 min après si besoin). IV : 0,5-5 mg lentement (hospitalier sous scope). Forme LP (Haldol Décanoas®) : 25-200 mg IM toutes les 4 semaines","contre_indications":["Maladie de Parkinson (aggravation sévère → CI absolue relative)","Coma ou dépression profonde du SNC","QTc > 500 ms (torsades de pointes)","Démences avec corps de Lewy (risque SEP sévère)","Hypersensibilité aux butyrophénones"],"effets_secondaires":["Syndrome extrapyramidal (SEP) : dystonie aiguë, akathisie, parkinsonisme médicamenteux (30-50%)","Dyskinésies tardives (traitement prolongé → parfois irréversibles)","Syndrome malin des neuroleptiques (SMN → urgence vitale)","Allongement QT + torsades de pointes","Hyperprolactinémie (aménorrhée, galactorrhée, gynécomastie)","Sédation modérée","Hypotension orthostatique"],"service":["Psychiatrie","Urgences","Gériatrie","Réanimation"],"mécanisme":"Antagoniste puissant et sélectif des récepteurs dopaminergiques D2. Blocage D2 mésolimbique → antipsychotique. Blocage D2 nigrostrié → syndrome extrapyramidal. Blocage D2 tubéro-infundibulaire → hyperprolactinémie. Faible action anticholinergique, H1 et alpha-bloquante.","interactions":["Médicaments allongeant le QT (amiodarone, citalopram, azithromycine, quinolones) → torsades de pointes","BZD, opioïdes, alcool → sédation additive et risque respiratoire","Antiparkinsoniens (lévodopa) → antagonisme","Lithium → ↑ neurotoxicité"],"niveau_preuve":"A","tags":["médicament","antipsychotique","neuroleptique","psychiatrie","urgences","agitation","SMN"],"revision":"2026-06-13"}}
---
...
- **Délire aigu**, **bouffée délirante**
- Syndrome confusionnel agité en gériatrie (faibles doses, hors AMM)
- Nausées/vomissements rebelles (très faibles doses)
...
- [ ] Mesurer **température corporelle** : toute fièvre + rigidité → alerte SMN immédiate
- [ ] Surveiller **PA, FC, conscience**
- [ ] Ne jamais administrer à un patient parkinsonien sans ordre médical
- [ ] Forme LP (Haldol Décanoas®) : injection IM profonde uniquement, alterner les sites
...
> [!danger] Syndrome Malin des Neuroleptiques (SMN)
