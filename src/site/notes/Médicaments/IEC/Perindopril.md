---
{"dg-publish":true,"permalink":"/Médicaments/IEC/Perindopril/","tags":["médicament","IEC","HTA","cardiologie"],"noteIcon":"","dg-note-properties":{"nom":"Périndopril","classe":["IEC","Inhibiteur de l'enzyme de conversion de l'angiotensine"],"indications":["Hypertension artérielle","Insuffisance cardiaque stable","Prévention cardiovasculaire secondaire (EUROPA)","Post-IDM avec FEVG réduite","Néphroprotection"],"posologie":"HTA : 5-10 mg/j en 1 prise (le matin). IC : initiation 2 mg/j → 4-8 mg/j. Utilisation courante avec indapamide (Bipreterax®)","contre_indications":["Angio-œdème sous IEC","Grossesse T2-T3 (fœtotoxique)","Sténose bilatérale artères rénales","Hyperkaliémie > 5,5 mmol/L"],"effets_secondaires":["Toux sèche (10-15% → bradykinine)","Hypotension première dose","Hyperkaliémie","IRA (déshydratation, AINS)","Angio-œdème (rare, grave)"],"service":["Cardiologie","Médecine interne","HTA"],"mécanisme":"IEC prodrogue → périndoprilate actif (estérases hépatiques). Inhibition ECA → ↓ angiotensine II → ↓ vasoconstriction + ↓ aldostérone + accumulation bradykinine. Demi-vie longue → 1 prise/j. Très utilisé en association fixe avec l'indapamide (Bipreterax®).","interactions":["AINS → ↓ antihypertenseur + ↑ IRA","Épargneurs K⁺ → hyperkaliémie","Triple whammy (IEC + AINS + diurétique) → IRA","Lithium → ↑ lithiémie"],"niveau_preuve":"A","tags":["médicament","IEC","HTA","cardiologie"],"revision":"2026-06-13"}}
---
...
- Hypertension artérielle → très souvent prescrit sous forme d'association fixe avec l'indapamide dans le BIPRETERAX®
- Insuffisance cardiaque stable
- Prévention cardiovasculaire secondaire chez les coronariens stables (étude EUROPA)
- Post-IDM avec dysfonction VG
...
- [ ] Si BIPRETERAX® : surveiller aussi hypoK⁺ et hypoNa⁺ (composant indapamide)
...
- [[Médicaments/Diurétiques/Indapamide\|Indapamide]] (association BIPRETERAX®)
- [[Médicaments/ARA2/Losartan\|Losartan]] (alternative si toux)
- [[Médicaments/IEC/Ramipril\|Ramipril]] (même classe, mécanisme IEC complet)
