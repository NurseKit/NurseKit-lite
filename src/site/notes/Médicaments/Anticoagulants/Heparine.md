...
> [!danger] TIH type II : urgence absolue
...
- [ ] **TCA** : prélèvement 6h après tout changement de débit, puis 1 fois/j si stable (cible 2-3× témoin)
- [ ] **NFS-plaquettes** : J0, J5, J10 (surveillance TIH)
- [ ] Surveiller les signes hémorragiques à chaque contact
- [ ] IVSE : vérifier perméabilité VVC, noter toute variation de débit
- [ ] Repérer la protamine : connaître sa localisation dans l'unité
- [ ] Ne jamais injecter en IM
...
3. **Antidote : protamine sulfate** → disponible en unité
...
> [!caution] Outil pédagogique : HAS, SFAR, RCP Héparine Choay
