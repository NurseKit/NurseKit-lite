---
{"dg-publish":true,"permalink":"/Médicaments/Anticoagulants/Comparatif Anticoagulants/","tags":["anticoagulant","comparatif","révision"],"dg-note-properties":{"nom":"Comparatif des anticoagulants","type":"Tableau comparatif","tags":["anticoagulant","comparatif","révision"],"revision":"2026-06-14"}}
---
...
| Critère | [[Médicaments/Anticoagulants/Heparine\|Héparine non fractionnée (HNF)]] | [[Médicaments/Anticoagulants/Enoxaparine\|HBPM]] | Fondaparinux | [[Médicaments/Anticoagulants/Warfarine\|AVK]] | AOD |
|---|---|---|---|---|---|
| **Mécanisme (cible)** | Anti-IIa + Anti-Xa via antithrombine | Anti-Xa >> Anti-IIa via antithrombine | Anti-Xa pur via antithrombine | Inhibe synthèse facteurs vit. K-dépendants (II, VII, IX, X) | Anti-IIa ([[Médicaments/Anticoagulants/Dabigatran\|Dabigatran]]) ou Anti-Xa ([[Médicaments/Anticoagulants/Rivaroxaban\|Rivaroxaban]], [[Médicaments/Anticoagulants/Apixaban\|Apixaban]]) |
...
| **Antidote** | Sulfate de protamine | Sulfate de protamine (efficacité partielle ~60 %) | Aucun antidote spécifique | Vitamine K + CCP (PPSB) en urgence | [[Médicaments/Anticoagulants/Dabigatran\|Dabigatran]] → Idarucizumab ; [[Médicaments/Anticoagulants/Rivaroxaban\|Rivaroxaban]]/[[Médicaments/Anticoagulants/Apixaban\|Apixaban]] → Andexanet alfa |
...
> [!danger] Erreurs à ne PAS faire à l'examen (et en pratique)
...
- **Idarucizumab (Praxbind®)** → antidote du **[[Médicaments/Anticoagulants/Dabigatran\|Dabigatran]] UNIQUEMENT** (anti-IIa). Inefficace pour les anti-Xa.
- **Andexanet alfa (Ondexxya®)** → anti-Xa ([[Médicaments/Anticoagulants/Rivaroxaban\|Rivaroxaban]], [[Médicaments/Anticoagulants/Apixaban\|Apixaban]]). Disponibilité encore limitée en France.
...
- [[Médicaments/Anticoagulants/Dabigatran\|Dabigatran]] surtout éliminé par voie rénale (80 %) → contre-indiqué si ClCr < 30 mL/min.
