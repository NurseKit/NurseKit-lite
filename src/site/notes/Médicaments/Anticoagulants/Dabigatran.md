...
> [!danger] Hémorragie sévère sous dabigatran
...
- [ ] Ne pas ouvrir les capsules (absorption +75% si ouverture → surdosage)
- [ ] Conseiller la prise avec eau abondante (dyspepsie)
- [ ] Vérifier absence de dronedarone et d'antifongiques azolés
- [ ] Avant chirurgie : délai d'arrêt selon ClCr (plus long si IR)
...
3. **Dronedarone = CI absolue** → interaction létale
