...
> 💡 Avantage vs héparine classique : durée d'action prévisible, pas de surveillance biologique en dose préventive (contrairement à l'[[HNF\|HNF]]).

---

## ⚠️ Ce qu'il ne faut PAS faire

> [!danger] [[HIT\|HIT]] : thrombopénie induite par l'héparine
> Entre J5 et J21 sous héparine : si les [[Plaquettes\|plaquettes]] chutent de > 50 % → suspecter une **HIT**. Paradoxalement : HIT = risque de **thrombose** (et non seulement hémorragie). **Arrêt immédiat de toute héparine** (y compris rinçage) + appel médecin. Antidote : argatroban ou danaparoïde.

> [!warning] Ne jamais injecter dans une zone avec hématome ou lipodystrophie
> Changer de zone à chaque injection. Zone préférée : abdomen (2 cm de l'ombilic), cuisse.

> [!caution] Insuffisance rénale
> HBPM éliminée par les reins → s'accumule si [[DFG\|DFG]] < 30. Adapter la dose ou passer à l'HNF (dosable par [[TCA\|TCA]]).
...
- [ ] Injection lente, ne pas masser après (risque hématome)
- [ ] Surveiller signes hémorragiques : hématomes, sang dans les urines/selles
- [ ] Si relais [[AVK\|AVK]] : contrôler [[INR\|INR]] quotidiennement
- [ ] **[[VVP\|VVP]] ou KT** en place → retirer 4h après la dernière injection préventive, 12h après dose curative
...
[[Plaquettes\|Plaquettes (HIT)]] · [[TCA\|TCA (HNF)]] · [[INR\|INR (relais AVK)]] · [[Médicaments/Anticoagulants/Warfarine\|Warfarine (AVK)]] · [[HBPM\|HBPM]] · [[HIT\|HIT]]
