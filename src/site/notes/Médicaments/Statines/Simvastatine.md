---
{"dg-publish":true,"permalink":"/Médicaments/Statines/Simvastatine/","tags":["médicament","statine","hypolipémiant","cardiovasculaire","CYP3A4"],"noteIcon":"","dg-note-properties":{"nom":"Simvastatine","classe":["Statine","Hypolipémiant"],"indications":["Hypercholestérolémie","Prévention cardiovasculaire secondaire","Dyslipidémie mixte"],"posologie":"10-40 mg/j le soir. Max 80 mg/j déconseillé (↑ myopathie). Si association amlodipine : max 20 mg/j. Si DFG < 30 : débuter 5 mg/j","contre_indications":["Grossesse + allaitement (tératogène)","Hépatopathie active","Inhibiteurs puissants CYP3A4 (clarithromycine, itraconazole, ciclosporine)","Association gemfibrozil (CI)"],"effets_secondaires":["Myalgies (2-7%)","Rhabdomyolyse (risque ++ si dose 80 mg)","Cytolyse hépatique","Diabète de novo"],"service":["Cardiologie","Médecine générale","Médecine interne"],"mécanisme":"Prodrogue liposoluble, inhibition HMG-CoA réductase, nombreuses interactions CYP3A4. Demi-vie courte → prise le soir obligatoire (synthèse cholestérol maximale la nuit). Dose 80 mg déconseillée (rhabdomyolyse trop fréquente).","interactions":["CYP3A4 (jus pamplemousse, macrolides, azolés → ↑ toxicité)","Amlodipine (max simvastatine 20 mg)","Amiodarone (max 20 mg)","Vérapamil (max 10 mg)","Fibrates (myopathie)"],"niveau_preuve":"A","tags":["médicament","statine","hypolipémiant","cardiovasculaire","CYP3A4"],"revision":"2026-06-13"}}
---
...
> - Hépatopathie active
> - Inhibiteurs CYP3A4 puissants : ciclosporine, itraconazole, clarithromycine
> - Gemfibrozil (fibrate fort, CI absolue)
> - Dose 80 mg/j (déconseillée, trop de rhabdomyolyse)

> [!warning] Interactions majeures : doses maximales à respecter
> | Médicament associé | Dose max simvastatine |
> |---|---|
> | Amlodipine ou vérapamil | **20 mg/j** |
> | Amiodarone | **20 mg/j** |
> | Diltiazem | **10 mg/j** |
> | Jus de pamplemousse | **CI** |
