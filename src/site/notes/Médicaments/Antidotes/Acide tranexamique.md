---
{"dg-publish":true,"permalink":"/Médicaments/Antidotes/Acide tranexamique/","tags":["médicament","hémostatique","urgence","hémorragie","maternité","traumatologie"],"noteIcon":"","dg-note-properties":{"nom":"Acide Tranexamique (Exacyl®, Cyklokapron®)","classe":["Antifibrinolytique","Hémostatique"],"indications":["Hémorragie du post-partum (HPP) dans la 1ère heure","Hémorragie traumatique (polytrauma dans les 3 h)","Hémorragie chirurgicale","Hémorragie de la fibrinolyse","Épistaxis sévère, hémoptysie"],"posologie":"IV urgence : 1 g IV sur 10 min (bolus lent), puis 1 g en 8 h si nécessaire · HPP : 1 g IV dès le diagnostic d'HPP","contre_indications":["Antécédent de thrombose veineuse profonde ou EP (relatif)","Hématurie d'origine haute (obstruction par caillots des voies urinaires)","CIVD avec phase fibrinolytique non établie (avec prudence)"],"effets_secondaires":["Nausées, vomissements (IV trop rapide)","Risque thrombotique (faible aux doses habituelles)",{"Rarement":"convulsions à très fortes doses"}],"service":["Urgences","Réanimation","Chirurgie","Maternité","Traumatologie"],"mécanisme":"Inhibe la plasmine et le plasminogène → bloque la lyse des caillots de fibrine déjà formés → maintient le caillot en place → effet hémostatique. N'est pas un facteur de coagulation, n'accélère pas la coagulation mais empêche la destruction du caillot.","interactions":["Facteurs de coagulation activés (FactVIIa, complexes prothrombiniques) → potentialisation du risque thrombotique"],"niveau_preuve":"A","tags":["médicament","hémostatique","urgence","hémorragie","maternité","traumatologie"],"revision":"2026-06-14"}}
---
...
> [!warning] Ne jamais injecter en bolus rapide
...
- [ ] Surveiller les constantes avant et après injection (TA, FC)
- [ ] 2ème dose si saignement persistant et prescription confirmée
- [ ] Tracer l'heure d'injection (délai crucial)
...
3. **Injection lente en 10 min** → bolus rapide = nausées garanties
...
> [!caution] Outil pédagogique : Études CRASH-2 (Lancet 2010) et WOMAN (Lancet 2017). Toujours vérifier les prescriptions médicales
