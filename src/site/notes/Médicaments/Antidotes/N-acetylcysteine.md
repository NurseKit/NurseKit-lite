...
- [ ] Monitoring des constantes : toutes les heures en phase 1, toutes les 4h ensuite
- [ ] Bilan hépatique ASAT/ALAT/INR avant de commencer, à H24 et H48
- [ ] Glycémie capillaire si signes d'insuffisance hépatique (ictère, confusion, astérixis)
- [ ] Toujours noter l'heure précise d'ingestion dans le dossier → c'est elle qui détermine la fenêtre thérapeutique
