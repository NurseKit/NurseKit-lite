...
> 2. Aspirer le maximum par la voie veineuse
> 3. NE PAS rincer (aggrave la diffusion)
> 4. Appeler le médecin
> 5. Dexrazoxane IV (Savene®) dans les 6h → antidote spécifique
> 6. Documenter et photographier la zone
> VVC ou PICC-line AVANT chaque cycle.

> [!danger] Cardiotoxicité cumulée irréversible
> Au-delà de 450-550 mg/m² cumulés → risque exponentiel de cardiomyopathie dilatée irréversible. FEVG à vérifier avant chaque cycle ou tous les 2 cycles. CI si FEVG < 50%.
...
- [ ] Tester le retour veineux avec SSI avant administration
- [ ] Surveiller en continu pendant la perfusion (douleur/brûlure = extravasation → ARRÊT)
- [ ] Informer le patient des urines rouges 24-48h (NORMAL)
...
> Fiche de révision ESI. ASCO 2023, ESMO 2023. Révision : 2026-06-07.
