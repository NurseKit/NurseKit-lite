---
{"dg-publish":true,"permalink":"/Médicaments/Chimiothérapies/Principes Chimiothérapie/","tags":["chimiothérapie","oncologie","soin-infirmier","sécurité"],"noteIcon":"","dg-note-properties":{"nom":"Principes généraux de chimiothérapie","classe":["Chimiothérapie"],"type":"Fiche transversale","tags":["chimiothérapie","oncologie","soin-infirmier","sécurité"],"revision":"2026-06-14"}}
---
...
Les agents chimiothérapeutiques (notamment les **agents alkylants** comme le [[Médicaments/Chimiothérapies/Cyclophosphamide\|Cyclophosphamide]]) sont :
...
> [!check] Équipements de Protection Individuelle obligatoires
...
> [!warning] Le masque chirurgical NE PROTÈGE PAS contre les vapeurs cytotoxiques. FFP2 minimum.
...
> [!tip] Avant toute administration

1. **Vérifier l'identité du patient** : contrôle des 5 B (Bon patient, Bon médicament, Bonne dose, Bonne voie, Bon moment).
2. **Vérifier la prescription** : ordonnance nominative sécurisée avec poids/surface corporelle, protocole validé, numéro de cure.
3. **Vérifier les résultats biologiques** (NFS, créatinine, bilan hépatique) → cure validée par le médecin oncologue.
4. **Vérifier la perméabilité de la voie** (VVP ou VVC) : tester le retour veineux, injecter du sérum physiologique et observer le site → pas de résistance, pas de tuméfaction, pas de douleur.
5. **Ne jamais forcer** si résistance à l'injection → risque d'extravasation.
6. Prémédication si prescrite (antiémétique, corticoïde, antihistaminique) : administrer **avant** la chimio selon les délais du protocole.

---

## 5. Extravasation : Urgence

> [!danger] Extravasation = urgence. protocole immédiat
...
1. **Arrêt immédiat** de la perfusion → NE PAS retirer l'aiguille ou le cathéter.
...
> [!danger] Filière de déchets spécifique. DASRI cytotoxique
...
> [!warning] Urines et selles du patient
...
> [!danger] Fièvre + neutropénie = URGENCE. délai < 1 heure
...
1. **Appel médecin immédiat** → ne pas attendre.
2. Hémocultures (2 paires, sites différents, avant antibiotiques).
3. **Antibiothérapie large spectre < 1 heure** (céphalosporine ou pipéracilline/tazobactam selon protocole local).
4. NFS, CRP, procalcitonine, ionogramme, créatinine, radiographie thoracique.
5. Isolement protecteur selon protocole du service.
6. Ne PAS donner de fébrifuge avant les prélèvements (masque le pic thermique).
...
|---|---|---|---|
| [[Médicaments/Chimiothérapies/Cisplatine\|Cisplatine]] | Agent alkylant (platine) | **Néphrotoxicité** (tubule proximal) + **neurotoxicité** (neuropathie périphérique) + ototoxicité | Diurèse horaire, créatininémie, bilan hydrique, hyperhydratation avant/pendant/après, signes de neuropathie (fourmillements) |
| [[Médicaments/Chimiothérapies/Cyclophosphamide\|Cyclophosphamide]] | Agent alkylant | **Cystite hémorragique** (acroléine, métabolite toxique pour la vessie) | Hyperhydratation, Mesna (uroprotecteur) systématique, hématurie, diurèse |
