...
>
> Le NDMA ne vient pas de la fabrication : il se forme spontanément dans la molécule de ranitidine elle-même lors du stockage, surtout au-dessus de 25°C. Autrement dit, même les médicaments correctement fabriqués devenaient dangereux avec le temps.
...
> - Ne jamais recommander, prescrire ni préparer ce médicament
> - Ne jamais utiliser sous prétexte que "les stocks sont encore là" → le NDMA est toujours présent

> [!warning] Alternatives validées
> - [[Médicaments/Antiacides/Famotidine\|Famotidine]] (Pepcid®) → anti-H2 de remplacement direct, sans risque NDMA
> - [[Médicaments/Antiacides/Omeprazole\|Oméprazole]] (Mopral®) → IPP de première ligne
> - [[Médicaments/Antiacides/Pantoprazole\|Pantoprazole]] (Eupantol®) → IPP, préféré sous clopidogrel
> - [[Médicaments/Antiacides/Lansoprazole\|Lansoprazole]] (Lanzor®) → IPP

> [!caution] Conduite à tenir si stocks à domicile
> - Informer le patient de ne plus consommer les boîtes
> - Orienter vers le médecin traitant pour une alternative
> - Ramener les boîtes en pharmacie → elles seront éliminées selon les procédures DASRI
...
- [ ] Ne jamais préparer ni administrer ce médicament → il n'est plus légalement disponible
...
3. **Alternative de première ligne** : un IPP (oméprazole ou pantoprazole selon le profil)
