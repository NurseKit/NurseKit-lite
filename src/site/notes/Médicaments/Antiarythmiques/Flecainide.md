---
{"dg-publish":true,"permalink":"/Médicaments/Antiarythmiques/Flecainide/","tags":["médicament","antiarythmique","classe_ic","FA","WPW","cardiologie"],"noteIcon":"","dg-note-properties":{"nom":"Flécaïnide","classe":["Antiarythmique","Classe IC (Vaughan Williams)","Bloqueur des canaux sodiques"],"indications":["Tachycardie supraventriculaire (TSV) paroxystique (WPW, TRIN)","Fibrillation auriculaire paroxystique (cardioversion pharmacologique → pill-in-the-pocket)","Flutter auriculaire paroxystique","Tachycardie ventriculaire paroxystique (cœur sain uniquement → CONTRE-INDIQUÉ si cardiopathie)"],"posologie":"PO : 100-200 mg x2/j. Cardioversion FA (pill-in-the-pocket) : 200-300 mg PO en 1 prise si FEVG conservée et pas de cardiopathie. IV : 2 mg/kg lentement (max 150 mg)","contre_indications":["Cardiopathie ischémique (ATCD IDM, angor instable) → RISQUE ARYTHMOGÈNE MAJEUR (CAST)","Dysfonction VG (FEVG < 40%) → même danger","BAV 2-3 non appareillé","Bloc de branche (QRS large préexistant)","Insuffisance cardiaque décompensée","Sinus maladie (sans pace-maker)"],"effets_secondaires":["Effet arythmogène (pro-arythmique → principal danger)","Troubles visuels (halos, diplopie)","Vertiges, céphalées","Nausées","Bradycardie, BAV","Allongement QRS (effet attendu → surveillance)"],"service":["Cardiologie","Urgences cardiologiques"],"mécanisme":"Antiarythmique classe IC : bloque les canaux Na⁺ voltage-dépendants → ↓ vitesse de conduction dans tout le cœur → terminaison des circuits de réentrée. DANGER si cardiopathie : pro-arythmie ventriculaire maligne (CAST 1989, ↑ mortalité post-IDM).","interactions":["Amiodarone → ↑ flécaïnide (inhibition CYP2D6) + pro-arythmie additive","Digoxine → ↑ digoxinémie (20-30%)","Antidépresseurs inhibiteurs CYP2D6 (fluoxétine, paroxétine) → ↑ flécaïnide","Vérapamil, diltiazem, BB → bradycardie/BAV additif"],"niveau_preuve":"A","tags":["médicament","antiarythmique","classe_ic","FA","WPW","cardiologie"],"revision":"2026-06-13"}}
---
...
> [!caution] Surveillance ECG obligatoire
...
- [ ] Surveiller FC et rythme (scope si disponible)
