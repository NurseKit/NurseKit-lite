---
{"dg-publish":true,"permalink":"/medicaments/antifongiques/amphotericine-b/","tags":["médicament","antifongique","polyène","infections_sévères","néphrotoxique","réanimation","VVC_obligatoire"],"noteIcon":"","dg-note-properties":{"nom":"Amphotericine_B","classe":["Antifongique","Polyène","Antifongique hospitalier de réserve"],"indications":["Infections fongiques invasives sévères (aspergillose, candidose systémique, cryptococcose, mucormycose)","Leishmaniose viscérale (forme liposomale Ambisome® uniquement)","Méningite à Cryptococcus neoformans (VIH → 1ère ligne en association flucytosine)"],"posologie":"Fungizone® (conventionnelle) : 0,25-1,5 mg/kg/j IV lente (4-6h) dans SG5% UNIQUEMENT. Ambisome® (liposomale) : 3-5 mg/kg/j IV sur 30-60 min. Toujours débuter par un test-dose de 1 mg sur 20 min","contre_indications":["Hypersensibilité documentée à l'amphotéricine B","Insuffisance rénale sévère sans indication vitale (forme conventionnelle Fungizone®)"],"effets_secondaires":["Néphrotoxicité dose-cumulée (forme conventionnelle → surveiller créatinine quotidiennement)","Hypokaliémie + hypomagnésémie (perte tubulaire)","Syndrome frissons-fièvre-céphalées pendant la perfusion (prémédication indispensable)","Phlébite sévère sur VVP (voie centrale obligatoire pour Fungizone®)","Anémie normochrome normocytaire (traitement prolongé)"],"service":["Réanimation","Hématologie","Infectiologie","Médecine interne"],"mécanisme":"Liaison directe à l'ergostérol membranaire fongique → formation de pores transmembranaires → fuite ionique (K⁺, Mg²⁺) → mort cellulaire fongique (effet fongicide). Mécanisme totalement différent des azolés (pas de résistances croisées)","interactions":["Néphrotoxiques (aminosides, ciclosporine, tacrolimus, AINS) → ↑↑ risque IRA → éviter les associations","Diurétiques, corticoïdes → ↑ hypokaliémie","Flucytosine → synergie (cryptococcose méningée)"],"niveau_preuve":"A","tags":["médicament","antifongique","polyène","infections_sévères","néphrotoxique","réanimation","VVC_obligatoire"],"revision":"2026-06-22"}}
---
...
- [ ] **Voie centrale ([[Cathéter veineux central\|VVC]]) obligatoire** pour Fungizone® → phlébite sévère et douloureuse sur VVP garantie
...
- [ ] Supplémentation préventive en K⁺ et Mg²⁺ si déficit
- [ ] Hydratation IV : 500 mL SSI avant chaque perfusion
...
- [[Cathéter veineux central\|VVC]] · Créatinine
