...
> [!abstract] En 2 mots
> Le valsartan est un ARA2 pour la tension et l'insuffisance cardiaque → sa forme combinée (Entresto® avec le sacubitril) est aujourd'hui le traitement phare de l'insuffisance cardiaque sévère. Surveiller le potassium et les reins comme pour tous les ARA2/IEC.
...
> - **IH sévère** (cirrhose biliaire : élimination hépatique)
> - **Entresto® + IEC simultanés** : risque d'angio-œdème → délai 36h entre arrêt IEC et 1ère dose Entresto®

> [!warning] Précautions importantes
> - **Hyperkaliémie > 5,5 mmol/L** : ne pas initier
> - **AINS** : éviter (IRA + hyperkaliémie)
...
> [!warning] Entresto® : délai IEC obligatoire
> Délai minimum de **36 heures** entre le dernier IEC et la 1ère dose d'Entresto®. L'association IEC + ARNI est contre-indiquée (risque d'angio-œdème grave).
