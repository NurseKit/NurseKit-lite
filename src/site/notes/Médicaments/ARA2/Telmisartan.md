...
> - **Insuffisance hépatique sévère** → CI ici car l'élimination est exclusivement biliaire : si le foie est hors jeu, le médicament s'accumule dangereusement
> - Sténose bilatérale des artères rénales
> - Association avec un IEC (double blocage SRAA)

> [!warning] Interactions à surveiller
> - IEC : hyperkaliémie + IRA (double blocage SRAA, à éviter)
> - **Digoxine** : le telmisartan peut augmenter modérément la digoxinémie → surveiller si association
> - AINS : risque d'IRA et hyperkaliémie

> [!caution] À surveiller
> - Kaliémie et créatinine à l'initiation puis à J15
> - Tension artérielle (hypotension à la première prise)
> - Bilan hépatique si signes d'atteinte hépatique
...
- [ ] Vérifier la fonction hépatique → attention : la CI habituelle des ARA2 (rénale) est inversée ici, c'est le foie qui compte
- [ ] Alerter si kaliémie > 5,5 mmol/L
- [ ] Si le patient est aussi sous digoxine, signaler l'association au médecin pour surveillance de la digoxinémie
- [ ] Rappeler l'interdiction de la grossesse sous ARA2
...
3. **"24h de demi-vie"** → une seule prise par jour avec effet couvrant les 24h → bonne observance
