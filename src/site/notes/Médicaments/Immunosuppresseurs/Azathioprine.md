---
{"dg-publish":true,"permalink":"/Médicaments/Immunosuppresseurs/Azathioprine/","tags":["médicament","immunosuppresseur","MICI","thiopurine","TPMT","allopurinol_ci","nfs_obligatoire"],"noteIcon":"","dg-note-properties":{"nom":"Azathioprine","classe":["Immunosuppresseur","Antiprolifératif","Thiopurine"],"indications":["Greffe (anti-rejet en association)","Polyarthrite rhumatoïde","Maladies inflammatoires chroniques intestinales (MICI → Crohn, RCH)","Lupus","Hépatite auto-immune","Myasthénie grave"],"posologie":"1-3 mg/kg/j en 1-2 prises. Débuter à faible dose (50 mg/j), augmenter progressivement. Surveillance NFS indispensable. Adapter si TPMT déficient.","contre_indications":["Hypersensibilité","Association allopurinol SANS réduction de dose (risque pancytopénie fatale)","Grossesse (risque → discuter bénéfice/risque)"],"effets_secondaires":["Myélosuppression (leucopénie, thrombopénie, anémie → RISQUE PRINCIPAL)","Nausées, vomissements (prendre avec repas)","Hépatotoxicité (cholestase)","Infections opportunistes","↑ Risque cancers (lymphomes) à long terme","Réaction d'hypersensibilité aiguë (fièvre, arthralgie, rash)"],"service":["Rhumatologie","Gastroentérologie","Transplantation","Neurologie"],"mécanisme":"Prodrogue → 6-mercaptopurine (6-MP) → 6-thioguanine nucléotides (6-TGN) → inhibition synthèse purines → ↓ prolifération lymphocytes T et B. Métabolisme par TPMT → variants génétiques → accumulation toxique.","interactions":["ALLOPURINOL : ↑↑ taux 6-MP (inhibition xanthine oxydase) → pancytopénie GRAVE → diviser dose azathioprine par 4 ou changer","Cotrimoxazole (↑ myélosuppression)","AINS (↑ toxicité)","Warfarine (↓ effet anticoagulant)"],"niveau_preuve":"A","tags":["médicament","immunosuppresseur","MICI","thiopurine","TPMT","allopurinol_ci","nfs_obligatoire"],"revision":"2026-06-13"}}
---
...
- [ ] Administrer avec le repas → ça réduit significativement les nausées
- [ ] Vérifier la NFS selon protocole → les leucocytes sont ta valeur sentinelle
- [ ] Surveiller bilan hépatique (transaminases, bilirubine)
- [ ] **Vérifier l'absence d'allopurinol dans l'ordonnance** → l'interaction peut être fatale
