---
{"dg-publish":true,"permalink":"/Médicaments/Immunosuppresseurs/Mycophénolate mofetil/","tags":["médicament","immunosuppresseur","transplantation","lupus","tératogène_majeur","gi_toxicité"],"noteIcon":"","dg-note-properties":{"nom":"Mycophenolate_mofetil","classe":["Immunosuppresseur","Antiprolifératif","Inhibiteur IMPDH"],"indications":["Prévention rejet greffe organe solide (2ème ligne, en association)","Néphropathie lupique","Myasthénie grave","Pemphigus (hors AMM)","MICI (hors AMM)"],"posologie":"Greffe : 1 g x2/j (MMF) ou acide mycophénolique 720 mg x2/j (Myfortic® EC). Lupus : 1,5-3 g/j en 2-3 prises","contre_indications":["Grossesse (tératogène +++) → contraception obligatoire","Allaitement","Hypersensibilité"],"effets_secondaires":["Troubles GI (diarrhée, nausées, vomissements → fréquents)","Leucopénie (NFS mensuelle)","Anémie","Infections opportunistes (CMV ++)","↑ Risque lymphome","Tératogène MAJEUR (malformations multiples)"],"service":["Transplantation","Rhumatologie","Neurologie"],"mécanisme":"Prodrogue → acide mycophénolique (MPA) → inhibition IMPDH → ↓ synthèse de novo de guanosine → bloque spécifiquement lymphocytes T et B (qui ne peuvent pas utiliser la voie de récupération des purines).","interactions":["Antiacides Al/Mg (↓ absorption → espacer 2h)","IPP (légère ↓ taux MMF)","Aciclovir/valaciclovir (compétition élimination rénale)","Tacrolimus/ciclosporine (interactions complexes → suivi taux)"],"niveau_preuve":"A","tags":["médicament","immunosuppresseur","transplantation","lupus","tératogène_majeur","gi_toxicité"],"revision":"2026-06-13"}}
---
...
> - Antiacides magnésium/aluminium → espacer de 2h (réduisent l'absorption)
> - Aciclovir/valaciclovir → compétition pour l'élimination rénale → surveiller

> [!caution] À surveiller
> - **NFS mensuelle** → la leucopénie peut s'installer progressivement et silencieusement
> - **Infections à CMV** → cytomégalovirus redoutable chez l'immunodéprimé (fièvre prolongée, asthénie)
...
- [ ] Éduquer : double contraception obligatoire → signaler toute grossesse immédiatement à l'équipe médicale
- [ ] Prendre avec un repas léger (réduit les nausées)
