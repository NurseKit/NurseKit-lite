---
{"dg-publish":true,"permalink":"/Médicaments/Bêta-bloquants/Atenolol/","tags":["médicament","bêta-bloquant","cardiosélectif","hydrosoluble","HTA"],"noteIcon":"","dg-note-properties":{"nom":"Aténolol","classe":["Bêta-bloquant","Bêta-1 sélectif (cardiosélectif)","Hydrosoluble"],"indications":["Hypertension artérielle","Angor stable","Tachycardie sinusale","Prévention secondaire post-IDM","Fibrillation auriculaire → contrôle de fréquence"],"posologie":"50-100 mg/j en 1 prise (demi-vie longue). Réduire si insuffisance rénale (élimination rénale)","contre_indications":["Bradycardie < 50/min","BAV 2 ou 3","Asthme/BPCO sévère (CI relative)","Choc cardiogénique","IC décompensée"],"effets_secondaires":["Bradycardie","Hypotension","Fatigue","Extrémités froides","Masquage hypoglycémie","Moins de troubles du SNC (hydrosoluble → ne passe pas la BHE)"],"service":["Cardiologie","Médecine interne","HTA"],"mécanisme":"Bêta-bloquant cardiosélectif β1, hydrosoluble. Bloque les récepteurs β1 myocardiques → ↓ FC, contractilité, conduction AV. Élimination rénale → adapter en IR. Hydrosolubilité → moins de passage BHE → moins d'effets neuropsychiques.","interactions":["Vérapamil, diltiazem IV → BAV/bradycardie (CI IV)","Amiodarone → bradycardie","AINS → ↓ effet antihypertenseur","Insuline → masquage hypoglycémie"],"niveau_preuve":"A","tags":["médicament","bêta-bloquant","cardiosélectif","hydrosoluble","HTA"],"revision":"2026-06-13"}}
---
...
- [ ] Surveiller la fonction rénale (adapter la posologie si créatinine ↑)
