...
- **Prémédication anesthésique** : anxiolyse + antiémèse avant une intervention
- **Insomnie occasionnelle** : souvent prescrite hors AMM pour son effet sédatif, mais les anti-H1 modernes sont préférables pour cet usage
...
> [!danger] CI absolues supplémentaires
> - Glaucome à angle fermé
> - Hypertrophie prostatique
> - Association avec les IMAO (interaction dangereuse)
...
> - Syndrome extrapyramidal (dystonie, torticolis) : moins fréquent que le métoclopramide mais possible → phénothiazine oblige
> - Rétention urinaire (anticholinergique) → surveiller la diurèse
...
- [ ] Surveiller la diurèse chez l'homme (rétention urinaire, terrain prostatique)
...
3. **IV = lente et diluée uniquement** → préférer la voie IM (nécrose locale et hypotension en IV rapide)
