...
- Score de Morse > 45 = risque élevé de chute : protocole systématique (sonnette, lit bas, bracelet, déambulateur)
- Communication : jamais compléter les phrases du patient aphasique, toujours des questions fermées, laisser du temps
- Côté hémiplégique insensible : inspection cutanée à chaque mobilisation (le patient ne ressent pas la douleur d'un début d'escarre)
- NIHSS : outil de surveillance neurologique structuré - toute aggravation > 4 points = appel médecin immédiat
