...
> [!tip]- Réponse Q2
> Le carbimazole (ATS : antithyroïdien de synthèse) peut provoquer une agranulocytose (PNN < 0,5 G/L). [[Médicaments/Normes/Leucocytes\|Leucocytes]] 3,2 G/L = leucopénie → NFS différentielle urgente pour compter les PNN. Si agranulocytose confirmée → arrêt immédiat du carbimazole (risque infectieux vital). Tout patient sous ATS avec fièvre + angine = STOP ATS + NFS urgente.

> [!tip]- Réponse Q3
> 1. Scope continu (FA, FC > 160 = risque insuffisance cardiaque à haut débit)
> 2. VVP + hydratation IV (déshydratation par hyperthermie + vomissements + diarrhées)
> 3. Refroidissement physique : linge humide frais, ventilateur (paracétamol IV : pas d'AINS sur thyroïde)
> 4. Bilan : TSH/T4L/T3L, NFS différentielle (agranulocytose), glycémie (hyperglycémie de stress), ionogramme, bilan hépatique
> 5. Appel cardiologue + endocrinologue (crise thyréotoxique = urgence spécialisée)

> [!tip]- Réponse Q4
> - **Carbimazole** : bloque la synthèse des hormones thyroïdiennes (mais les hormones déjà stockées restent)
> - **[[Médicaments/Bêta-bloquants/Propranolol\|Propranolol]]** (bêtabloquant) : contrôle la tachycardie et les symptômes adrénergiques (tremblement, agitation) + inhibe la conversion T4→T3
> - **[[Médicaments/Corticoïdes/Hydrocortisone\|Hydrocortisone]]** (corticoïde) : réduit la conversion T4→T3, traite l'insuffisance surrénalienne relative associée à la crise
...
[[Pathologies/Hyperthyroïdie\|Hyperthyroïdie]] · [[Pathologies/Fibrillation atriale\|Fibrillation atriale]] · [[Soins Infirmiers/Mémo urgences IDE\|Mémo urgences IDE]] · [[Stage Endocrinologie\|Stage Endocrinologie]]
