---
{"dg-publish":true,"permalink":"/exercices/cas-cliniques/cc-6-douleur-abdominale-aigue/","tags":["cas-clinique","révision","examen-ifsi","chirurgie","abdomen-aigu","appendicite","urgences"],"noteIcon":"","dg-note-properties":{"nom":"Cas clinique 6 - Douleur abdominale aiguë","type":"Cas clinique","tags":["cas-clinique","révision","examen-ifsi","chirurgie","abdomen-aigu","appendicite","urgences"],"revision":"2026-06-24"}}
---
...
> [!info]- Fiches liées
> [[Douleur\|Douleur]] · [[Soins Infirmiers/Transmissions ciblees DAR\|Transmissions DAR]] · [[Soins Infirmiers/VVP\|VVP]] · [[Médicaments/Antalgiques/Comparatif Antalgiques\|Antalgiques]] · [[Post-op\|Post-op]]
...
> 1. **Migration de la douleur** : débute péri-ombilicale (douleur viscérale diffuse liée à l'inflammation initiale de l'appendice), puis se localise en **FID** (irritation péritonéale localisée)
> 2. **Point de McBurney positif** : douleur élective à la pression du point situé à l'union 1/3 externe - 2/3 interne de la ligne ombilic-épine iliaque antéro-supérieure droite → siège classique de l'appendice
> 3. **Signe de Blumberg positif** + défense localisée en FID → réaction péritonéale localisée, témoignant d'une irritation du péritoine pariétal
...
>
> 1. **Identité et check-list pré-opératoire** (protocole HAS) : identité du patient (bracelet, date de naissance), côté opéré identifié si applicable, consentement éclairé signé, allergie vérifiée et notifiée sur la check-list
> 2. **Jeûne vérifié** : heure du dernier repas et du dernier verre → tracer dans la check-list. Prothèses dentaires, lentilles, bijoux retirés
> 3. **Bilan biologique et imagerie disponibles** : résultats biologiques + échographie/scanner abdomen si réalisés, accessibles pour l'anesthésiste et le chirurgien
> 4. **VVP perméable et prémédicaments administrés** : selon prescription anesthésiste (anxiolytique, antiémétique), vérifier le débit de perfusion, étiqueter la VVP, contrôler la perméabilité

---

> [!example] Transmission DAR - Cible : Douleur abdominale aiguë / [[Pathologies/Appendicite\|Appendicite]]
