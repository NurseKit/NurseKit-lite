...
- [[Médicaments/Normes/Glasgow\|Glasgow]] : 14 (légèrement confuse)
...
Le médecin prescrit : [[Médicaments/Antibiotiques/Amoxicilline\|Amoxicilline]]-acide clavulanique 1,2 g IV toutes les 8h + [[Médicaments/Antibiotiques/Azithromycine\|Azithromycine]] 500 mg PO une fois par jour. Pourquoi cette bithérapie ? Que vérifiez-vous avant d'administrer l'amoxicilline-clavulanate ?

### Question 5

La glycémie capillaire à l'arrivée est à 2,15 g/L. Mme Aubert est sous [[Médicaments/Antidiabétiques/Metformine\|Metformine]] 1g x2/j. Quelle décision IDE s'impose et pourquoi ?
...
> [!success] Réponse
> **[[Pathologies/Pneumonie\|Pneumonie]] communautaire (PAC) :**
>
...
> |---------|------------------------|
> | **C**onfusion ([[Médicaments/Normes/Glasgow\|Glasgow]] < 15 ou désorientation) | ✓ [[Médicaments/Normes/Glasgow\|Glasgow]] 14 |
> | **R**FR ≥ 30/min | ✓ 28/min → borderline, certains protocoles retiennent ≥ 25 |
> | **B**P systolique < 90 ou diastolique ≤ 60 | ✓ TA 102/65 (diastolique 65, systolique limite) |
...
>
> 1. **[[Soins Infirmiers/Oxygénothérapie\|Oxygénothérapie]] immédiate** : SpO2 90 % → O2 par lunettes nasales ou masque simple, objectif SpO2 ≥ 92-94 % (attention BPCO : risque de freiner la commande ventilatoire si > 96 %)
> 2. **Installer en position semi-assise** → facilite l'expansion thoracique, réduit la dyspnée
> 3. **Poser le monitoring continu** : scope, SpO2, PA automatique → patient à risque de dégradation rapide
> 4. **Poser ou vérifier la VVP** → nécessaire pour l'antibiothérapie IV et le remplissage si hypotension confirmée
>
...
>
> - **[[Médicaments/Antibiotiques/Amoxicilline\|Amoxicilline]]-clavulanate** : bêtalactamine à spectre élargi, actif sur *S. pneumoniae*, *H. influenzae*, streptocoques, anaérobies → couvre les germes banaux de la PAC sévère
> - **[[Médicaments/Antibiotiques/Azithromycine\|Azithromycine]]** : macrolide, actif sur les bactéries **intracellulaires** (*Mycoplasma pneumoniae*, *Chlamydophila pneumoniae*, *Legionella*) → la PAC sévère peut être due à un germe atypique non couvert par la bêtalactamine seule
...
> - [[Médicaments/Normes/Créatinine\|Créatinine]] → DFG 42 mL/min : insuffisance rénale modérée → vérifier si adaptation de dose prescrite (habituellement intervalle allongé)
...
> [!success] Réponse
> **[[Médicaments/Normes/Glycémie\|Glycémie]] 2,15 g/L sous [[Médicaments/Antidiabétiques/Metformine\|Metformine]] → décision IDE :**
>
> **Alerter immédiatement le médecin** pour suspendre la [[Médicaments/Antidiabétiques/Metformine\|Metformine]].
>
> **Pourquoi :**
...
> [!example] Transmission DAR - Cible : Détresse respiratoire / [[Pathologies/Pneumonie\|Pneumonie]] communautaire sévère
...
> [!caution] Outil pédagogique ESI · Corrigé indicatif, non exhaustif
