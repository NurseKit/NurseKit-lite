---
{"dg-publish":true,"permalink":"/Exercices/Cas Cliniques/Transmissions IDM/","tags":["transmissions","DAR","IDM","cardiologie","USIC"],"noteIcon":"","dg-note-properties":{"nom":"Transmissions ciblées - Infarctus du myocarde","classe":["Cas clinique"],"type":"Transmissions ciblées","tags":["transmissions","DAR","IDM","cardiologie","USIC"],"revision":"2026-06-14"}}
---
...
- **Carte double antiagrégation** : à remettre systématiquement, à présenter avant tout acte chirurgical ou dentaire
- Le syndrome de loge post-radiale est une urgence vasculaire : douleur + paresthésies + tension → appel médecin immédiat
- L'anxiété post-IDM est une réaction normale : écoute active, explication du monitoring, orientation psychologue
- L'ETP débute dès J1-J2 en USIC (phase initiale) : informations simples, brochures, introduction progressive
