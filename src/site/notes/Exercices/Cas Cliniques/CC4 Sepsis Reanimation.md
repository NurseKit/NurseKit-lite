...
- [[Médicaments/Normes/Glasgow\|Glasgow]] : 13 (Y3V4M6), confusion nouvelle
...
- [[Médicaments/Normes/Créatinine\|Créatinine]] : 198 µmol/L (basale préopératoire : 72 µmol/L)
- [[Médicaments/Normes/Lactates\|Lactates]] artériels : 3,2 mmol/L (N < 2)
- [[Médicaments/Normes/Plaquettes\|Plaquettes]] : 87 000/mm3

La plaie opératoire est propre. La stomie est fonctionnelle. La patiente est sous [[Médicaments/Antibiotiques/Amoxicilline\|Amoxicilline]]-Acide clavulanique IV depuis J0.
...
Citez les 4 éléments du "bundle sepsis 1 heure" de la Surviving [[Pathologies/Sepsis\|Sepsis]] Campaign (SSC) et expliquez l'objectif de chacun.
...
> | Altération de la conscience | [[Médicaments/Normes/Glasgow\|Glasgow]] < 15 | **OUI : [[Médicaments/Normes/Glasgow\|Glasgow]] 13** |
>
> **Score qSOFA : 3/3**
>
> **Implications :**
...
> - Dans ce cas, associé à des lactates > 2 mmol/L et une hypotension malgré la perfusion, le tableau correspond à un **choc septique** (définition [[Pathologies/Sepsis\|Sepsis]]-3 : sepsis + hypotension nécessitant vasopresseurs + lactates > 2 mmol/L).
...
>
> 1. **Mesurer les lactates artériels**
>    - Objectif : évaluer la perfusion tissulaire. [[Médicaments/Normes/Lactates\|Lactates]] > 2 mmol/L : hypoperfusion cellulaire. [[Médicaments/Normes/Lactates\|Lactates]] > 4 mmol/L : choc septique sévère, mortalité > 40%.
>    - Contrôle à 2h pour évaluer la réponse au traitement (clearance des lactates > 10% : signe favorable).
>
> 2. **Prélever des hémocultures (avant antibiotiques)**
...
>
> 3. **Débuter une antibiothérapie probabiliste à large spectre**
...
>
> 4. **Remplissage vasculaire par cristalloïdes : 30 mL/kg en 3 heures**
...
>
> 1. **Voie veineuse centrale obligatoire** : la noradrénaline est un vasoconstricteur puissant. Son passage extra-vasculaire provoque une nécrose tissulaire sévère. Ne jamais administrer sur VVP > 1h (risque d'extravasation).
>
> 2. **Surveillance tensionnelle continue** : idéalement par **pression artérielle invasive** (cathéter artériel radial ou fémoral), assurant une mesure instantanée, continue et fiable. Sinon, TA non invasive toutes les 15 minutes minimum.
>
> 3. **Surveillance des extrémités** : coloration, temps de recoloration cutanée, chaleur des extrémités. La noradrénaline provoque une vasoconstriction périphérique : risque d'ischémie des extrémités (doigts, orteils) en cas de surdosage ou de terrain vasculaire défavorable.
>
> 4. **Diurèse horaire stricte** (sonde urinaire en place) : objectif > 0,5 mL/kg/h. Ici, Mme Fontaine a 80 mL en 4 heures soit 20 mL/h : oligurie franche, signe d'insuffisance rénale aiguë septique.
>
> 5. **Surveillance du débit IVSE** : seringue autopousseuse dédiée, alarmes programmées, pas d'interruption brutale (risque d'hypotension sévère en cas d'arrêt non préparé).
>
> 6. **Bilan biologique répété** : lactates, ionogramme, NFS, coagulation (CIVD), créatinine toutes les 4 à 6 heures.
...
> [!example] Transmission DAR - Cible : [[Pathologies/Choc septique\|Choc septique]] post-opératoire
