---
{"dg-publish":true,"permalink":"/Exercices/Calculs Doses/Exercices Pédiatrie/","tags":["calculs-doses","ue-4-4","exercices","pédiatrie"],"noteIcon":"","dg-note-properties":{"nom":"Calculs de doses - Pédiatrie mg/kg","type":"Exercices pratiques","tags":["calculs-doses","ue-4-4","exercices","pédiatrie"],"revision":"2026-06-14"}}
---
...
1. Quelle dose en mg ?
2. Quel volume ?
3. Vérifier que la dose ne dépasse pas le maximum.
...
2. Quelle dose par prise en mg ?
3. Quel volume par prise ?
...
**Questions :**
1. Quel débit en mL/h ?
2. Quel débit en gtt/min ?
...
**Questions :**
1. Quelle dose en mg par prise ?
2. Quel volume à perfuser ?
3. Combien de mg/j au total (4 prises) ?
...
> [!info] MEOPA. Pas de calcul de dose, mais des règles à connaître
...
**Questions :**
1. Dose journalière en mg ?
2. Volume de solvant pour reconstituer à 50 mg/mL ?
3. Dose par injection en mg ?
4. Volume par injection ?
...
>
> **Conduite à tenir :**
> 1. Ne jamais administrer sans vérification si la dose semble anormale
> 2. Rappeler immédiatement le médecin prescripteur
