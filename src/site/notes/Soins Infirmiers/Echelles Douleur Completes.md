...
- **Avantages** : gold standard en recherche clinique, sensible aux variations
- **Limites** : nécessite la compréhension du concept abstrait de l'analogie visuelle → difficultés chez les personnes âgées ou peu scolarisées
