---
{"dg-publish":true,"permalink":"/Soins Infirmiers/Prévention infections nosocomiales/","tags":["soin","infection","nosocomiale","hygiène","précautions","isolement"],"dg-note-properties":{"titre":"Prévention des Infections Nosocomiales","tags":["soin","infection","nosocomiale","hygiène","précautions","isolement"],"revision":"2026-06-16"}}
---
...
| 2 | Avant une procédure aseptique (VVP, pansement) |
...
| Infection | Prévention clé |
|-----------|---------------|
| IUAS (infection urinaire sur sonde) | Sondage aseptique, retrait précoce, circuit fermé |
| ILC (infection liée au cathéter) | Asepsie manipulation, pansement occlusif, retrait dès possible |
| ISO (infection site opératoire) | Antibioprophylaxie, préparation cutanée, normothermie |
| PAVM (pneumonie sous VM) | Tête de lit > 30°, soins de bouche, décontamination oropharynx |

> [!tip] EPI selon acte
> Soin sans contact avec liquides : rien ou tablier plastique
> Risque projections : masque + lunettes de protection
> Acte invasif (VVP, ponction) : gants non stériles minimum, stériles si technique aseptique
