...
> [!danger] Complications à surveiller
...
- [ ] SpO₂, FC, FR avant, pendant et après, sans oublier de tracer les valeurs
- [ ] Aspect des sécrétions : couleur (jaune/vert = infectieux ?), quantité, viscosité → noter dans le dossier
- [ ] Signes de détresse post aspiration → ventilation manuelle au masque si nécessaire
- [ ] Préférer le **circuit fermé** chez l'intubé : moins de contamination, pas de déconnexion du respirateur
