...
> [!tip] Pourquoi le SBAR plutôt qu'un récit chronologique ?
...
> [!note] Les deux outils sont complémentaires
...
3. **Le R doit être explicite** : ne pas attendre que le médecin devine ce qu'on veut - formuler clairement la demande ("je vous demande de venir", "j'attends une prescription", "faut-il déclencher le protocole X ?").
