...
- [ ] **Toujours peser l'enfant** à l'admission (peser à jeun si possible)
- [ ] Doses en mg/kg (certains médicaments : mL/kg ou UI/kg)
- [ ] **Double vérification** obligatoire pour tout médicament IV chez l'enfant < 6 ans
- [ ] Utiliser une seringue graduée au 0,1 mL (pas les seringues adultes au mL)
- [ ] Vérifier la concentration du médicament avant de préparer
...
> [!danger] Déshydratation aiguë rapide chez le nourrisson
