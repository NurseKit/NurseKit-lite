...
> [!info] Mécanisme : une inflammation chronique des bronches
...
> [!info] Classification GINA (severité)
...
> [!warning] Identifier ses déclencheurs : tenir un agenda asthme
...
> [!info] Le débitmètre de pointe (Peak Flow Meter)
...
> [!info] Les 3 zones du traffic light system
...
> [!info] Les deux grandes familles de traitement
...
> [!danger] Technique d'inhalation : erreurs dans 80% des cas
> Une mauvaise technique rend le traitement inefficace. Vérifier et corriger à chaque consultation.

> [!tip] Aérosol doseur pressurisé (MDI) : technique correcte
...
> [!tip] Inhalateur de poudre sèche (DPI) : technique différente
...
> [!warning] Rinçage de bouche après CSI
...
> [!info] Le PAP : document écrit individualisé
...
> [!tip] Conduite à tenir selon la zone
...
> [!danger] Zone rouge : crise sévère
...
> [!info] Acariens : 1er allergène de l'asthme allergique
...
> [!danger] Tabac : risque multiplié par 3
