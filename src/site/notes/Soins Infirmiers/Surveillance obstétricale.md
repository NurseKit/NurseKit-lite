...
- [ ] BU (protéinurie ?)
- [ ] Mise en place du monitoring + identification des capteurs (cœur fœtal = bleu, CU = blanc ou gris)
- [ ] Vérifier la bonne détection de la FCF (confondre avec le pouls maternel = erreur grave)

**En cours de travail :**
- [ ] Analyser le tracé CTG toutes les 15-30 min (toutes les 5 min en phase expulsive)
...
> [!danger] Variabilité < 5 bpm pendant > 30 min
