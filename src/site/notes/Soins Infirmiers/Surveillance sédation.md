---
{"dg-publish":true,"permalink":"/soins-infirmiers/surveillance-sedation/","tags":["soin-infirmier","réanimation","sédation","analgésie","RASS","scores"],"noteIcon":"","dg-note-properties":{"nom":"Surveillance Sédation-Analgésie en Réanimation","classe":["Soin infirmier"],"type":"Surveillance et évaluation","systeme":"Réanimation","tags":["soin-infirmier","réanimation","sédation","analgésie","RASS","scores"],"revision":"2026-06-22"}}
---
...
- [ ] **RASS** : évaluer et noter → comparer à la cible prescrite
- [ ] **BPS ou CPOT** : évaluer et noter → BPS ≥ 5 = traitement antalgique
- [ ] **CAM-ICU** une fois par poste (ou si comportement inhabituel)
- [ ] Adapter les drogues IVSE selon la cible et les scores :
...
- [ ] Évaluation quotidienne : "Spontaneous Awakening Trial" (SAT) → tenter l'interruption de sédation chaque matin si possible
- [ ] Surveiller les constantes à l'ajustement des doses : TA, FC, FR, SpO₂
- [ ] Évaluer la possibilité de réduction des vasopresseurs si stabilisation hémodynamique
- [ ] En cas d'agitation : chercher d'abord une cause (douleur, globe vésical, position inconfortable, hypoxie) avant d'augmenter la sédation

## Points de vigilance

> [!danger] Sur-sédation = complication en soi
...
> [!warning] Délire = urgence diagnostique
...
> [!caution] Sevrage de la sédation
