---
{"dg-publish":true,"permalink":"/soins-infirmiers/injection-sc/","tags":["soin-infirmier","geste","injection","sous-cutanée","insuline","HBPM"],"noteIcon":"","dg-note-properties":{"nom":"Injection sous-cutanée (SC)","systeme":"Administration médicamenteuse","tags":["soin-infirmier","geste","injection","sous-cutanée","insuline","HBPM"],"revision":"2026-06-22"}}
---
...
- [ ] Choisir le site en alternant systématiquement → noter sur le schéma de rotation : abdomen (2 cm autour du nombril), face externe du bras, face antéro-externe des cuisses, fesses
- [ ] Désinfecter, laisser sécher
- [ ] Faire un pli cutané entre pouce et index → sauf aiguille ≤ 8 mm sur abdomen chez l'obèse
- [ ] Piquer à **45°** (aiguille longue ≥ 12 mm) ou **90°** (aiguille courte ≤ 8 mm)
- [ ] Injecter lentement → **ne pas aspirer** (contrairement à l'IM)
- [ ] Retirer doucement → **ne pas masser** après l'injection
- [ ] Éliminer dans le collecteur DASRI immédiatement
...
> [!caution] Outil pédagogique : HAS, ANSM
