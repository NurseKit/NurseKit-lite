...
- [ ] **Traçabilité** : date, évaluation TIMED, pansement utilisé, prochain changement prévu

> [!warning] Antiseptiques sur plaie en cours de cicatrisation
...
- Plaie propre en bourgeonnement : toutes les 48-72 h (laisser le bourgeon tranquille)
- Plaie très exsudative : selon saturation du pansement
- Plaie infectée : quotidien sur prescription médicale
- Toujours noter le prochain changement dans le dossier
